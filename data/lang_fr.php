...
return array (
  'accessibility.onboarding.accessibility.button' => 'Accessibilité...',
  'accessibility.onboarding.accessibility.button.narration' => 'Options d\'accessibilité',
...
Souhaitez-vous activer le narrateur ou accéder aux options d\'accessibilité ?',
  ...
  'advMode.notEnabled' => 'Les blocs de commande ne sont pas activés',
  'advMode.notEnabled.spawner' => 'Les générateurs ne sont pas activés',
  'advMode.previousOutput' => 'Résultat précédent',
  'advMode.setCommand' => 'Définir une commande pour le bloc',
  'advMode.setCommand.disabled' => 'Commande définie : %s, mais les blocs de commande sont toujours désactivés',
  ...
  'advancements.adventure.arbalistic.description' => 'Tuez cinq créatures de types différents d\'un seul tir d\'arbalète.',
  ...
  'advancements.adventure.heart_transplanter.description' => 'Placez un cœur de grinceur avec le bon alignement entre deux bûches de chêne pâle.',
  'advancements.adventure.heart_transplanter.title' => 'Greffeur de cœur',
  ...
  'advancements.adventure.spear_many_mobs.description' => 'Touchez cinq créatures avec une lance lors d\'une même attaque chargée.',
  'advancements.adventure.spear_many_mobs.title' => 'Une belle brochette',
...
Songez peut-être à rester à l\'écart des villages pour le moment...',
  ...
  'advancements.husbandry.place_dried_ghast_in_water.description' => 'Placez un Ghast desséché dans de l\'eau.',
  'advancements.husbandry.place_dried_ghast_in_water.title' => 'Trempé jusqu\'aux os',
  ...
  'advancements.husbandry.uh_oh.description' => 'Faites absorber un bloc de TNT à un cube de soufre.',
  'advancements.husbandry.uh_oh.title' => 'Ça va péter !',
  ...
  'argument.hexcolor.invalid' => 'Code de couleur hexadécimal non valide : %s',
  ...
  'argument.resource_or_id.no_such_element' => 'Impossible de trouver l\'élément "%s" dans le registre "%s"',
  ...
  'argument.swing_animation.invalid' => 'Type d\'animation d\'agitation de bras inconnu : %s',
  ...
  'argument.waypoint.invalid' => 'L\'entité sélectionnée n\'est pas un point de repère',
  ...
  'attribute.name.air_drag_modifier' => 'modificateur de résistance à l\'air',
  ...
  'attribute.name.below_name_distance' => 'distance d\'affichage du score du nom',
  ...
  'attribute.name.bounciness' => 'rebond',
  'attribute.name.burning_time' => 'temps en feu',
  'attribute.name.camera_distance' => 'distance de la caméra',
  ...
  'attribute.name.friction_modifier' => 'modificateur de friction',
  ...
  'attribute.name.nameplate_distance' => 'distance d\'affichage du nom',
  ...
  'attribute.name.waypoint_receive_range' => 'portée de réception du point de repère',
  'attribute.name.waypoint_transmit_range' => 'portée de transmission du point de repère',
  ...
  'biome.minecraft.dappled_forest' => 'Forêt ambrée',
  ...
  'biome.minecraft.sulfur_caves' => 'Cavernes de soufre',
  ...
  'block.minecraft.acacia_shelf' => 'Étagère en acacia',
  ...
  'block.minecraft.bamboo_shelf' => 'Étagère en bambou',
  ...
  'block.minecraft.birch_shelf' => 'Étagère en bouleau',
  ...
  'block.minecraft.black_concrete_slab' => 'Dalle de béton noir',
  'block.minecraft.black_concrete_stairs' => 'Escalier en béton noir',
  ...
  'block.minecraft.black_wool_slab' => 'Dalle de laine noire',
  'block.minecraft.black_wool_stairs' => 'Escalier en laine noire',
  ...
  'block.minecraft.blue_concrete_slab' => 'Dalle de béton bleu',
  'block.minecraft.blue_concrete_stairs' => 'Escalier en béton bleu',
  ...
  'block.minecraft.blue_wool_slab' => 'Dalle de laine bleue',
  'block.minecraft.blue_wool_stairs' => 'Escalier en laine bleue',
  ...
  'block.minecraft.brown_concrete_slab' => 'Dalle de béton marron',
  'block.minecraft.brown_concrete_stairs' => 'Escalier en béton marron',
  ...
  'block.minecraft.brown_wool_slab' => 'Dalle de laine marron',
  'block.minecraft.brown_wool_stairs' => 'Escalier en laine marron',
  ...
  'block.minecraft.cherry_shelf' => 'Étagère en cerisier',
  ...
  'block.minecraft.chiseled_cinnabar' => 'Cinabre sculpté',
  ...
  'block.minecraft.chiseled_sulfur' => 'Soufre sculpté',
  ...
  'block.minecraft.cinnabar' => 'Cinabre',
  'block.minecraft.cinnabar_brick_slab' => 'Dalle de cinabre taillé',
  'block.minecraft.cinnabar_brick_stairs' => 'Escalier en cinabre taillé',
  'block.minecraft.cinnabar_brick_wall' => 'Muret de cinabre taillé',
  'block.minecraft.cinnabar_bricks' => 'Cinabre taillé',
  'block.minecraft.cinnabar_slab' => 'Dalle de cinabre',
  'block.minecraft.cinnabar_stairs' => 'Escalier en cinabre',
  'block.minecraft.cinnabar_wall' => 'Muret de cinabre',
  ...
  'block.minecraft.copper_bars' => 'Barreaux de cuivre',
  'block.minecraft.copper_block' => 'Bloc de cuivre',
  'block.minecraft.copper_bulb' => 'Ampoule en cuivre',
  'block.minecraft.copper_chain' => 'Chaîne en cuivre',
  'block.minecraft.copper_chest' => 'Coffre en cuivre',
  'block.minecraft.copper_door' => 'Porte en cuivre',
  'block.minecraft.copper_golem_statue' => 'Statue de golem de cuivre',
  'block.minecraft.copper_grate' => 'Grille en cuivre',
  'block.minecraft.copper_lantern' => 'Lanterne en cuivre',
  'block.minecraft.copper_ore' => 'Minerai de cuivre',
  'block.minecraft.copper_torch' => 'Torche de cuivre',
  'block.minecraft.copper_trapdoor' => 'Trappe en cuivre',
  'block.minecraft.copper_wall_torch' => 'Torche de cuivre murale',
  ...
  'block.minecraft.crimson_shelf' => 'Étagère carmin',
  ...
  'block.minecraft.cyan_concrete_slab' => 'Dalle de béton cyan',
  'block.minecraft.cyan_concrete_stairs' => 'Escalier en béton cyan',
  ...
  'block.minecraft.cyan_wool_slab' => 'Dalle de laine cyan',
  'block.minecraft.cyan_wool_stairs' => 'Escalier en laine cyan',
  ...
  'block.minecraft.dark_oak_shelf' => 'Étagère en chêne noir',
  ...
  'block.minecraft.dried_ghast' => 'Ghast desséché',
  ...
  'block.minecraft.exposed_copper_bars' => 'Barreaux de cuivre exposé',
  'block.minecraft.exposed_copper_bulb' => 'Ampoule en cuivre exposé',
  'block.minecraft.exposed_copper_chain' => 'Chaîne en cuivre exposé',
  'block.minecraft.exposed_copper_chest' => 'Coffre en cuivre exposé',
  'block.minecraft.exposed_copper_door' => 'Porte en cuivre exposé',
  'block.minecraft.exposed_copper_golem_statue' => 'Statue de golem de cuivre exposé',
  'block.minecraft.exposed_copper_grate' => 'Grille en cuivre exposé',
  'block.minecraft.exposed_copper_lantern' => 'Lanterne en cuivre exposé',
  ...
  'block.minecraft.exposed_lightning_rod' => 'Paratonnerre exposé',
  ...
  'block.minecraft.golden_dandelion' => 'Pissenlit doré',
  ...
  'block.minecraft.gray_concrete_slab' => 'Dalle de béton gris',
  'block.minecraft.gray_concrete_stairs' => 'Escalier en béton gris',
  ...
  'block.minecraft.gray_wool_slab' => 'Dalle de laine grise',
  'block.minecraft.gray_wool_stairs' => 'Escalier en laine grise',
  ...
  'block.minecraft.green_concrete_slab' => 'Dalle de béton vert',
  'block.minecraft.green_concrete_stairs' => 'Escalier en béton vert',
  ...
  'block.minecraft.green_wool_slab' => 'Dalle de laine verte',
  'block.minecraft.green_wool_stairs' => 'Escalier en laine verte',
  ...
  'block.minecraft.iron_chain' => 'Chaîne en fer',
  ...
  'block.minecraft.jungle_shelf' => 'Étagère en acajou',
  ...
  'block.minecraft.light_blue_concrete_slab' => 'Dalle de béton bleu clair',
  'block.minecraft.light_blue_concrete_stairs' => 'Escalier en béton bleu clair',
  ...
  'block.minecraft.light_blue_wool_slab' => 'Dalle de laine bleu clair',
  'block.minecraft.light_blue_wool_stairs' => 'Escalier en laine bleu clair',
  ...
  'block.minecraft.light_gray_concrete_slab' => 'Dalle de béton gris clair',
  'block.minecraft.light_gray_concrete_stairs' => 'Escalier en béton gris clair',
  ...
  'block.minecraft.light_gray_wool_slab' => 'Dalle de laine gris clair',
  'block.minecraft.light_gray_wool_stairs' => 'Escalier en laine gris clair',
  ...
  'block.minecraft.lime_concrete_slab' => 'Dalle de béton vert clair',
  'block.minecraft.lime_concrete_stairs' => 'Escalier en béton vert clair',
  ...
  'block.minecraft.lime_wool_slab' => 'Dalle de laine vert clair',
  'block.minecraft.lime_wool_stairs' => 'Escalier en laine vert clair',
  ...
  'block.minecraft.magenta_concrete_slab' => 'Dalle de béton magenta',
  'block.minecraft.magenta_concrete_stairs' => 'Escalier en béton magenta',
  ...
  'block.minecraft.magenta_wool_slab' => 'Dalle de laine magenta',
  'block.minecraft.magenta_wool_stairs' => 'Escalier en laine magenta',
  ...
  'block.minecraft.mangrove_shelf' => 'Étagère en palétuvier',
  ...
  'block.minecraft.oak_shelf' => 'Étagère en chêne',
  ...
  'block.minecraft.orange_concrete_slab' => 'Dalle de béton orange',
  'block.minecraft.orange_concrete_stairs' => 'Escalier en béton orange',
  'block.minecraft.orange_glazed_terracotta' => 'Terre cuite émaillée orange',
  'block.minecraft.orange_poplar_leaves' => 'Feuilles de peuplier orange',
  ...
  'block.minecraft.orange_wool_slab' => 'Dalle de laine orange',
  'block.minecraft.orange_wool_stairs' => 'Escalier en laine orange',
  ...
  'block.minecraft.oxidized_copper_bars' => 'Barreaux de cuivre oxydé',
  'block.minecraft.oxidized_copper_bulb' => 'Ampoule en cuivre oxydé',
  'block.minecraft.oxidized_copper_chain' => 'Chaîne en cuivre oxydé',
  'block.minecraft.oxidized_copper_chest' => 'Coffre en cuivre oxydé',
  'block.minecraft.oxidized_copper_door' => 'Porte en cuivre oxydé',
  'block.minecraft.oxidized_copper_golem_statue' => 'Statue de golem de cuivre oxydé',
  'block.minecraft.oxidized_copper_grate' => 'Grille en cuivre oxydé',
  'block.minecraft.oxidized_copper_lantern' => 'Lanterne en cuivre oxydé',
  ...
  'block.minecraft.oxidized_lightning_rod' => 'Paratonnerre oxydé',
  ...
  'block.minecraft.pale_oak_shelf' => 'Étagère en chêne pâle',
  ...
  'block.minecraft.pink_concrete_slab' => 'Dalle de béton rose',
  'block.minecraft.pink_concrete_stairs' => 'Escalier en béton rose',
  ...
  'block.minecraft.pink_wool_slab' => 'Dalle de laine rose',
  'block.minecraft.pink_wool_stairs' => 'Escalier en laine rose',
  ...
  'block.minecraft.polished_cinnabar' => 'Cinabre poli',
  'block.minecraft.polished_cinnabar_slab' => 'Dalle de cinabre poli',
  'block.minecraft.polished_cinnabar_stairs' => 'Escalier en cinabre poli',
  'block.minecraft.polished_cinnabar_wall' => 'Muret de cinabre poli',
  ...
  'block.minecraft.polished_sulfur' => 'Soufre poli',
  'block.minecraft.polished_sulfur_slab' => 'Dalle de soufre poli',
  'block.minecraft.polished_sulfur_stairs' => 'Escalier en soufre poli',
  'block.minecraft.polished_sulfur_wall' => 'Muret de soufre poli',
  ...
  'block.minecraft.poplar_button' => 'Bouton en peuplier',
  'block.minecraft.poplar_door' => 'Porte en peuplier',
  'block.minecraft.poplar_fence' => 'Barrière en peuplier',
  'block.minecraft.poplar_fence_gate' => 'Portillon en peuplier',
  'block.minecraft.poplar_hanging_sign' => 'Pancarte suspendue en peuplier',
  'block.minecraft.poplar_leaves' => 'Feuilles de peuplier',
  'block.minecraft.poplar_log' => 'Bûche de peuplier',
  'block.minecraft.poplar_planks' => 'Planches de peuplier',
  'block.minecraft.poplar_pressure_plate' => 'Plaque de pression en peuplier',
  'block.minecraft.poplar_sapling' => 'Pousse de peuplier',
  'block.minecraft.poplar_shelf' => 'Étagère en peuplier',
  'block.minecraft.poplar_sign' => 'Pancarte en peuplier',
  'block.minecraft.poplar_slab' => 'Dalle en peuplier',
  'block.minecraft.poplar_stairs' => 'Escalier en peuplier',
  'block.minecraft.poplar_trapdoor' => 'Trappe en peuplier',
  'block.minecraft.poplar_wall_hanging_sign' => 'Pancarte suspendue en peuplier murale',
  'block.minecraft.poplar_wall_sign' => 'Pancarte en peuplier murale',
  'block.minecraft.poplar_wood' => 'Bois de peuplier',
  'block.minecraft.poppy' => 'Coquelicot',
  'block.minecraft.potatoes' => 'Pommes de terre',
  'block.minecraft.potent_sulfur' => 'Soufre concentré',
  ...
  'block.minecraft.potted_golden_dandelion' => 'Pissenlit doré en pot',
  ...
  'block.minecraft.potted_poplar_sapling' => 'Pousse de peuplier en pot',
  ...
  'block.minecraft.purple_concrete_slab' => 'Dalle de béton violet',
  'block.minecraft.purple_concrete_stairs' => 'Escalier en béton violet',
  ...
  'block.minecraft.purple_wool_slab' => 'Dalle de laine violette',
  'block.minecraft.purple_wool_stairs' => 'Escalier en laine violette',
  ...
  'block.minecraft.red_concrete_slab' => 'Dalle de béton rouge',
  'block.minecraft.red_concrete_stairs' => 'Escalier en béton rouge',
  ...
  'block.minecraft.red_poplar_leaves' => 'Feuilles de peuplier rouges',
  ...
  'block.minecraft.red_shrub' => 'Buisson rouge',
  ...
  'block.minecraft.red_wool_slab' => 'Dalle de laine rouge',
  'block.minecraft.red_wool_stairs' => 'Escalier en laine rouge',
  ...
  'block.minecraft.shelf_mushroom' => 'Polypore',
  ...
  'block.minecraft.spruce_shelf' => 'Étagère en sapin',
  ...
  'block.minecraft.straw_bed' => 'Lit de paille',
  ...
  'block.minecraft.stripped_poplar_log' => 'Bûche de peuplier écorcée',
  'block.minecraft.stripped_poplar_wood' => 'Bois de peuplier écorcé',
  ...
  'block.minecraft.sulfur' => 'Soufre',
  'block.minecraft.sulfur_brick_slab' => 'Dalle de soufre taillé',
  'block.minecraft.sulfur_brick_stairs' => 'Escalier en soufre taillé',
  'block.minecraft.sulfur_brick_wall' => 'Muret de soufre taillé',
  'block.minecraft.sulfur_bricks' => 'Soufre taillé',
  'block.minecraft.sulfur_slab' => 'Dalle de soufre',
  'block.minecraft.sulfur_spike' => 'Pointe de soufre',
  'block.minecraft.sulfur_stairs' => 'Escalier en soufre',
  'block.minecraft.sulfur_wall' => 'Muret de soufre',
  ...
  'block.minecraft.warped_shelf' => 'Étagère biscornue',
  ...
  'block.minecraft.white_concrete_slab' => 'Dalle de béton blanc',
  'block.minecraft.white_concrete_stairs' => 'Escalier en béton blanc',
  ...
  'block.minecraft.white_wool_slab' => 'Dalle de laine blanche',
  'block.minecraft.white_wool_stairs' => 'Escalier en laine blanche',
  ...
  'block.minecraft.yellow_concrete_slab' => 'Dalle de béton jaune',
  'block.minecraft.yellow_concrete_stairs' => 'Escalier en béton jaune',
  'block.minecraft.yellow_glazed_terracotta' => 'Terre cuite émaillée jaune',
  'block.minecraft.yellow_poplar_leaves' => 'Feuilles de peuplier jaunes',
  ...
  'block.minecraft.yellow_wool_slab' => 'Dalle de laine jaune',
  'block.minecraft.yellow_wool_stairs' => 'Escalier en laine jaune',
  'block.minecraft.zombie_head' => 'Tête de zombie',
  'block.minecraft.zombie_wall_head' => 'Tête de zombie murale',
  'book.byAuthor' => 'par %1$s',
  'book.edit.title' => 'Écran de modification du livre',
  ...
  'book.page_button.next' => 'Page suivante',
  'book.page_button.previous' => 'Page précédente',
  'book.sign.title' => 'Écran de signature du livre',
  'book.sign.titlebox' => 'Titre',
  'book.signButton' => 'Signer',
  'book.view.title' => 'Écran de lecture du livre',
  'build.spawn_protection' => '%s est sous la protection de la zone d\'apparition',
  'build.tooHigh' => 'La hauteur maximale de construction est de %s',
  'build.tooLow' => 'La hauteur minimale de construction est de %s',
  ...
  'chat.queue.tooltip' => 'Cliquez pour afficher le prochain message',
  ...
  'chat_restriction.chat_and_commands_disabled_by_options' => 'Le tchat est restreint dans les paramètres du client.',
  'chat_restriction.chat_disabled_by_options' => 'Le tchat des joueurs est restreint dans les paramètres du client.',
  'chat_restriction.chat_disabled_by_options.action' => 'Accéder à l\'écran des paramètres du tchat',
  'chat_restriction.disabled_by_launcher' => 'Le tchat est restreint par le Launcher.',
  'chat_restriction.disabled_by_profile' => 'Le tchat est restreint par les paramètres du profil.',
  'chat_restriction.disabled_by_profile.action' => 'Accéder aux paramètres de votre profil',
  'chat_screen.commands_not_allowed' => 'L\'envoi de commandes n\'est pas autorisé',
  'chat_screen.message' => 'Message à envoyer : %s',
  'chat_screen.messages_not_allowed' => 'L\'envoi de messages dans le tchat n\'est pas autorisé',
  'chat_screen.restricted' => 'Le tchat est restreint. Cliquez sur ce message pour plus de détails.',
  'chat_screen.restricted.narration' => 'Le tchat est restreint. Accédez à l\'écran des restrictions dans les options du monde.',
  ...
  'command.compute.result.named.exact' => '%s a renvoyé la valeur %s',
  'command.compute.result.named.invalid' => '%s a renvoyé une valeur non valide (%s)',
  'command.compute.result.named.rounded' => '%s a renvoyé la valeur %s (arrondie à %s)',
  'command.compute.result.unnamed.exact' => 'Le fournisseur de nombres a renvoyé la valeur %s',
  'command.compute.result.unnamed.invalid' => 'Le fournisseur de nombres a renvoyé une valeur non valide (%s)',
  'command.compute.result.unnamed.rounded' => 'Le fournisseur de nombres a renvoyé la valeur %s (arrondie à %s)',
  ...
  'command.trailing_data' => 'Données de fin trouvées : %s',
  ...
  'commands.bossbar.get.visible.hidden' => 'La barre de boss personnalisée %s est actuellement masquée',
  'commands.bossbar.get.visible.visible' => 'La barre de boss personnalisée %s est actuellement visible',
  ...
  'commands.bossbar.set.max.success' => 'La barre de boss personnalisée %s a changé sa valeur maximale à %s',
  'commands.bossbar.set.max.unchanged' => 'Rien n\'a changé, c\'est déjà la valeur maximale de cette barre de boss',
  ...
  'commands.bossbar.set.players.unchanged' => 'Rien n\'a changé, ces joueurs sont déjà sur la barre de boss sans personne à ajouter ou à retirer',
  ...
  'commands.bossbar.set.value.success' => 'La barre de boss personnalisée %s a changé sa valeur à %s',
  ...
  'commands.bossbar.set.visible.success.hidden' => 'La barre de boss personnalisée %s est maintenant masquée',
  ...
  'commands.clone.success' => 'Clonage de %s bloc(s)',
  'commands.clone.toobig' => 'Trop de blocs dans la zone spécifiée (%s au maximum, %s spécifiés)',
  'commands.damage.invulnerable' => 'La cible est invulnérable au type de dégât spécifié',
  ...
  'commands.datapack.create.already_exists' => 'Un pack existe déjà sous le nom "%s"',
  'commands.datapack.create.invalid_full_name' => '"%s" n\'est pas un nom de pack valide',
  'commands.datapack.create.invalid_name' => 'Caractères non valides dans le nom du nouveau pack : %s',
  'commands.datapack.create.io_failure' => 'Impossible de créer un pack sous le nom "%s". Consultez les journaux',
  'commands.datapack.create.metadata_encode_failure' => 'Échec de l\'encodage des métadonnées pour le pack nommé "%s" : %s',
  'commands.datapack.create.success' => 'Un pack vide a été créé sous le nom "%s"',
  ...
  'commands.dialog.clear.multiple' => 'Le dialogue a été effacé pour %s joueurs',
  'commands.dialog.clear.single' => 'Le dialogue a été effacé pour %s',
  'commands.dialog.show.multiple' => 'Le dialogue a été affiché à %s joueurs',
  'commands.dialog.show.single' => 'Le dialogue a été affiché à %s',
  ...
  'commands.effect.clear.everything.failed' => 'La cible n\'a aucun effet à retirer',
  ...
  'commands.fetchprofile.copy_component' => 'Copier le composant',
  'commands.fetchprofile.copy_text' => 'Copier %s',
  'commands.fetchprofile.entity.success' => 'Profil résolu pour l\'entité "%s" : %s',
  'commands.fetchprofile.failed_to_serialize' => 'Échec de la sérialisation du profil : %s',
  'commands.fetchprofile.give_item' => 'Donner l\'objet',
  'commands.fetchprofile.id.failure' => 'Échec de la résolution du profil pour l\'ID "%s"',
  'commands.fetchprofile.id.success' => 'Profil résolu pour l\'ID "%s" : %s',
  'commands.fetchprofile.name.failure' => 'Échec de la résolution du profil pour le nom "%s"',
  'commands.fetchprofile.name.success' => 'Profil résolu pour le nom "%s" : %s',
  'commands.fetchprofile.no_profile' => 'L\'entité "%s" n\'a pas de profil',
  'commands.fetchprofile.summon_mannequin' => 'Invoquer un mannequin',
  'commands.fill.failed' => 'Aucun bloc n\'a été rempli',
  'commands.fill.success' => 'Remplissage de %s bloc(s)',
  'commands.fill.toobig' => 'Trop de blocs dans la zone spécifiée (%s au maximum, %s spécifiés)',
  'commands.fillbiome.no_changes' => 'Aucune entrée de biome n\'a été modifiée',
  ...
  'commands.gamerule.not_set' => 'La règle de jeu %s est déjà définie sur "%s"',
  'commands.gamerule.query' => 'La règle de jeu %s est actuellement définie sur "%s"',
  'commands.gamerule.set' => 'La règle de jeu %s est maintenant définie sur "%s"',
  ...
  'commands.item.block.modify.success' => '%s emplacement(s) modifié(s) en %s, %s, %s',
  'commands.item.block.replace.success' => '%s emplacement(s) remplacé(s) en %s, %s, %s',
  'commands.item.block.replace.success.known_item' => '%s emplacement(s) remplacé(s) en %s, %s, %s par %s',
  'commands.item.block.set.success' => 'L\'emplacement en %s, %s, %s a été remplacé par %s',
  'commands.item.entity.modify.success.multiple' => 'Emplacement(s) modifié(s) sur %s entités',
  'commands.item.entity.modify.success.single' => '%s emplacement(s) modifié(s) sur %s',
  'commands.item.entity.replace.success.multiple' => 'Emplacement(s) remplacé(s) sur %s entités',
  'commands.item.entity.replace.success.multiple.known_item' => 'Emplacement(s) remplacé(s) sur %s entités par %s',
  'commands.item.entity.replace.success.single' => '%s emplacement(s) remplacé(s) sur %s',
  'commands.item.entity.replace.success.single.known_item' => '%s emplacement(s) remplacé(s) sur %s par %s',
  ...
  'commands.item.source.no_such_slot.unnamed' => 'La source n\'a pas les emplacements spécifiés',
  'commands.item.source.not_a_container' => 'La position source en %s, %s, %s n\'est pas un conteneur',
  'commands.item.target.failed' => 'Aucune cible n\'a accepté les objets dans les emplacements spécifiés',
  'commands.item.target.failed.known_item' => 'Aucune cible n\'a accepté l\'objet %s dans les emplacements spécifiés',
  ...
  'commands.item.target.no_such_slot.unnamed' => 'La cible n\'a pas les emplacements spécifiés',
  ...
  'commands.perf.started' => 'Démarrage du profilage des performances pour une durée de 10 secondes (utilisez "/perf stop" pour l\'interrompre)',
  'commands.perf.stopped' => 'Arrêt du profilage des performances après %s seconde(s) et %s tick(s) (%s tick(s) par seconde)',
  ...
  'commands.place.feature.success.inline' => 'L\'élément a été placé en %s, %s, %s',
  ...
  'commands.posteffect.add.failed' => 'Le joueur a déjà l\'effet de post-traitement spécifié',
  'commands.posteffect.add.success.multiple' => 'L\'effet de post-traitement %s a été ajouté à %s joueurs',
  'commands.posteffect.add.success.single' => 'L\'effet de post-traitement %s a été ajouté à %s',
  'commands.posteffect.clear.failed' => 'Le joueur n\'a aucun effet de post-traitement à retirer',
  'commands.posteffect.clear.success.multiple' => 'Tous les effets de post-traitement ont été retirés de %s joueurs',
  'commands.posteffect.clear.success.single' => 'Tous les effets de post-traitement ont été retirés de %s',
  'commands.posteffect.list.empty' => 'Le joueur %s n\'a aucun effet de post-traitement',
  'commands.posteffect.list.success' => 'Le joueur %s a %s effets de post-traitement : %s',
  'commands.posteffect.remove.failed' => 'Le joueur n\'a pas l\'effet de post-traitement spécifié',
  'commands.posteffect.remove.success.multiple' => 'L\'effet de post-traitement %s a été retiré de %s joueurs',
  'commands.posteffect.remove.success.single' => 'L\'effet de post-traitement %s a été retiré de %s',
  'commands.profile_fetch.copy_component' => 'Copier le composant',
  'commands.profile_fetch.failed_to_serialize' => 'Échec de la sérialisation du profil : %s',
  'commands.profile_fetch.give_item' => 'Donner l\'objet',
  'commands.profile_fetch.id.failure' => 'Échec de la résolution du profil pour l\'ID "%s"',
  'commands.profile_fetch.id.success' => 'Profil résolu pour l\'ID "%s" : %s',
  'commands.profile_fetch.name.failure' => 'Échec de la résolution du profil pour le nom "%s"',
  'commands.profile_fetch.name.success' => 'Profil résolu pour le nom "%s" : %s',
  'commands.publish.alreadyPublished' => 'La partie multijoueur est déjà hébergée sur le port %s',
  'commands.publish.alreadyPublished.lan' => 'La partie locale est déjà hébergée sur le port %s',
  'commands.publish.alreadyPublished.online' => 'La partie en ligne est déjà hébergée',
  ...
  'commands.publish.started.lan' => 'Partie locale hébergée sur le port %s',
  'commands.publish.started.online' => 'Partie en ligne hébergée',
  'commands.publish.success' => 'La partie multijoueur est maintenant hébergée sur le port %s',
  'commands.random.error.range_too_large' => 'L\'intervalle de la valeur aléatoire doit être au maximum de 2147483647',
  'commands.random.error.range_too_small' => 'L\'intervalle de la valeur aléatoire doit être d\'au moins 1',
  ...
  'commands.scoreboard.players.display.name.clear.success.multiple' => 'Le nom d\'affichage de %s entités a été effacé dans l\'objectif %s',
  'commands.scoreboard.players.display.name.clear.success.single' => 'Le nom d\'affichage de %s a été effacé dans l\'objectif %s',
  'commands.scoreboard.players.display.name.set.success.multiple' => 'Le nom d\'affichage de %2$s entités a été changé en %1$s dans l\'objectif %3$s',
  'commands.scoreboard.players.display.name.set.success.single' => 'Le nom d\'affichage de %2$s a été changé en %1$s dans l\'objectif %3$s',
  'commands.scoreboard.players.display.numberFormat.clear.success.multiple' => 'Le format numérique de %s entités a été effacé dans l\'objectif %s',
  'commands.scoreboard.players.display.numberFormat.clear.success.single' => 'Le format numérique de %s a été effacé dans l\'objectif %s',
  'commands.scoreboard.players.display.numberFormat.set.success.multiple' => 'Le format numérique de %s entités a été changé dans l\'objectif %s',
  'commands.scoreboard.players.display.numberFormat.set.success.single' => 'Le format numérique de %s a été changé dans l\'objectif %s',
  ...
  'commands.scoreboard.players.get.null' => 'Impossible d\'obtenir la valeur de l\'objectif "%s" pour %s parce qu\'aucune n\'a été définie',
  ...
  'commands.setworldspawn.success.new' => 'Le point d\'apparition du monde a été défini en %s, %s, %s [%s, %s] dans la dimension %s',
  'commands.spawnpoint.success.multiple' => 'Le point d\'apparition a été défini en %s, %s, %s [%s] dans la dimension %s pour %s joueurs',
  'commands.spawnpoint.success.multiple.new' => 'Le point d\'apparition a été défini en %s, %s, %s [%s, %s] dans la dimension %s pour %s joueurs',
  'commands.spawnpoint.success.single' => 'Le point d\'apparition a été défini en %s, %s, %s [%s] dans la dimension %s pour %s',
  'commands.spawnpoint.success.single.new' => 'Le point d\'apparition a été défini en %s, %s, %s [%s, %s] dans la dimension %s pour %s',
  'commands.spectate.cannot_spectate' => 'Impossible d\'observer du point de vue de l\'entité "%s"',
  ...
  'commands.stopwatch.already_exists' => 'Le chronomètre "%s" existe déjà',
  'commands.stopwatch.create.success' => 'Le chronomètre "%s" a été créé',
  'commands.stopwatch.does_not_exist' => 'Le chronomètre "%s" n\'existe pas',
  'commands.stopwatch.query' => 'Le chronomètre "%s" a tourné pendant %s s',
  'commands.stopwatch.remove.success' => 'Le chronomètre "%s" a été supprimé',
  'commands.stopwatch.restart.success' => 'Le chronomètre "%s" a été redémarré',
  'commands.summon.failed' => 'Impossible d\'invoquer l\'entité',
  'commands.summon.failed.peaceful' => 'Les monstres ne peuvent pas être invoqués en difficulté Paisible',
  ...
  'commands.swing.failed.notliving' => 'Aucune entité vivante n\'a été trouvée pour agiter son bras',
  'commands.swing.success.multiple' => '%s entités ont agité leurs bras',
  'commands.swing.success.single' => '%s a agité son bras',
  ...
  'commands.team.option.color.clear.success' => 'La couleur de l\'équipe %s a été effacée',
  ...
  'commands.team.option.friendlyfire.disabled' => 'Le tir allié a été désactivé pour l\'équipe %s',
  'commands.team.option.friendlyfire.enabled' => 'Le tir allié a été activé pour l\'équipe %s',
  ...
  'commands.team.option.prefix.success' => 'Le préfixe d\'équipe a été changé en "%s"',
  ...
  'commands.team.option.seeFriendlyInvisibles.disabled' => 'L\'équipe %s ne peut plus voir ses coéquipiers invisibles',
  'commands.team.option.seeFriendlyInvisibles.enabled' => 'L\'équipe %s peut maintenant voir ses coéquipiers invisibles',
  'commands.team.option.suffix.success' => 'Le suffixe d\'équipe a été changé en "%s"',
  ...
  'commands.test.batch.starting' => 'Démarrage de l\'environnement %s du lot %s',
...
Temps moyen par tick : %s ms',
  ...
  'commands.time.no_default_clock' => 'Il n\'y a pas d\'horloge par défaut dans la dimension %s',
  'commands.time.no_time_marker_found' => 'Le repère de temps %s n\'existe pas pour l\'horloge %s',
  'commands.time.pause' => 'L\'horloge %s a été mise en pause',
  'commands.time.pause.already_paused' => 'L\'horloge %s est déjà en pause',
  'commands.time.pause.already_running' => 'L\'horloge %s tourne déjà',
  'commands.time.query' => 'Temps : %s ticks',
  'commands.time.query.absolute' => 'L\'horloge %s est à %s tick(s)',
  'commands.time.query.gametime' => 'Le temps de jeu est de %s tick(s)',
  'commands.time.query.timeline' => 'Le cycle %s est à %s tick(s)',
  'commands.time.query.timeline.repetitions' => 'Le cycle %s s\'est répété %s fois',
  'commands.time.rate' => 'L\'horloge %s avancera maintenant à %s fois la vitesse normale',
  'commands.time.rate.already_same' => 'L\'horloge %s avance déjà à %s fois la vitesse normale',
  'commands.time.resume' => 'L\'horloge %s a repris',
  'commands.time.set' => 'Le temps a été fixé à %s ticks',
  'commands.time.set.absolute' => 'L\'horloge %s a été réglée à %s tick(s)',
  'commands.time.set.already_at_time' => 'L\'horloge %s est déjà à %s tick(s)',
  'commands.time.set.already_at_time_marker' => 'L\'horloge %s est déjà au repère de temps %s',
  'commands.time.set.time_marker' => 'L\'horloge %s a été réglée au repère de temps %s',
  'commands.time.wrong_timeline_for_clock' => 'Le cycle %s n\'est pas valide pour l\'horloge %s',
  ...
  'commands.trigger.add.success' => '%s a été déclenché (valeur augmentée de %s)',
  ...
  'commands.trigger.set.success' => '%s a été déclenché (valeur définie à %s)',
  'commands.trigger.simple.success' => '%s a été déclenché',
  'commands.unpublish.notPublished' => 'Aucune partie multijoueur publiée',
  'commands.unpublish.success' => 'La partie multijoueur n\'est plus publiée',
  ...
  'commands.waypoint.list.empty' => 'Il n\'y a pas de points de repère dans la dimension %s',
  'commands.waypoint.list.success' => 'Il y a %s point(s) de repère dans la dimension %s : %s',
  'commands.waypoint.modify.color' => 'La couleur du point de repère est maintenant %s',
  'commands.waypoint.modify.color.reset' => 'La couleur du point de repère a été réinitialisée',
  'commands.waypoint.modify.style' => 'Le style du point de repère a été modifié',
  ...
  'component.profile.dynamic' => 'Dynamique',
  ...
  'connect.p2p.establishing' => 'Établissement de la connexion...',
  'connect.p2p.failed.generic' => 'Impossible de se connecter au joueur',
  'connect.p2p.failed.signaling' => 'Il n\'est pas possible de se connecter pour le moment.
Réessayez plus tard.',
  'connect.p2p.failed.timeout' => 'Demande de connexion expirée',
  'connect.p2p.failed.unreachable' => 'Le joueur est injoignable',
...
%s',
  ...
  'createWorld.customize.buffet.search' => 'Rechercher...',
  ...
  'dataPack.locator_bar.description' => 'Affiche la position des autres joueurs en multijoueur',
  'dataPack.locator_bar.name' => 'Barre de localisation',
  ...
  'datapackFailure.title' => 'Des erreurs dans le(s) pack(s) de données sélectionné(s) empêchent le chargement du monde.
Vous pouvez soit essayer de le charger uniquement avec le pack de données vanilla ("mode sans échec"), soit retourner au menu principal et corriger le problème manuellement.',
  ...
  'death.attack.spear' => '%1$s s\'est fait transpercer par (un(e)) %2$s',
  'death.attack.spear.item' => '%1$s s\'est fait transpercer par (un(e)) %2$s avec %3$s',
  ...
  'death.attack.sulfurCubeHot' => '%1$s est mort(e) car il n\'y a pas que le sol qui est fait de lave',
  'death.attack.sulfurCubeHot.item' => '%2$s a montré à %1$s qu\'il n\'y a pas que le sol qui est fait de lave avec %3$s',
  'death.attack.sulfurCubeHot.player' => '%2$s a montré à %1$s qu\'il n\'y a pas que le sol qui est fait de lave',
  ...
  'debug.copy_location.help' => 'F3 + C = Copier la position en tant que commande /tp ou maintenir pendant 10 secondes pour faire planter le jeu',
  ...
  'debug.crash.message.rebindable' => 'Les touches %s + %s sont maintenues enfoncées. Cela fera planter le jeu sauf si vous les relâchez.',
  ...
  'debug.entry.always' => 'Toujours',
  'debug.entry.currently.alwaysOn' => '%s : actuellement toujours visible',
  'debug.entry.currently.inF3' => '%s : actuellement uniquement dans F3',
  'debug.entry.currently.inOverlay' => '%s : actuellement uniquement dans l\'overlay de débogage',
  'debug.entry.currently.never' => '%s : actuellement masqué',
  'debug.entry.f3' => 'Dans F3',
  'debug.entry.overlay' => 'Overlay',
  ...
  'debug.improvedTransparency.off' => 'Transparence améliorée : désactivée',
  'debug.improvedTransparency.on' => 'Transparence améliorée : activée',
  ...
  'debug.options.category.renderer' => 'Moteurs de rendu de débogage',
  'debug.options.category.text' => 'Texte de l\'écran de débogage',
  'debug.options.help' => 'F3 + F6 = Modifier les paramètres de débogage',
  'debug.options.notAllowed.tooltip' => 'Non visible lorsque l\'information de débogage est réduite.',
  'debug.options.profile.default' => 'Profil par défaut',
  'debug.options.profile.performance' => 'Profil de performance',
  'debug.options.search' => 'Rechercher...',
  'debug.options.title' => 'Paramètres de débogage',
  'debug.options.warning' => 'Ces paramètres ne sont proposés qu\'à des fins de test. Ils sont susceptibles de ralentir votre ordinateur, faire planter le jeu ou voler votre goûter.',
  ...
  'debug.profiling.start' => 'Démarrage du profilage pour une durée de %s secondes. Utilisez F3 + L pour interrompre',
  'debug.profiling.start.rebindable' => 'Démarrage du profilage pour une durée de %s secondes. Utilisez %s + %s pour interrompre',
  ...
  'debug.version.header' => 'Informations sur la version du client :',
  'debug.version.help' => 'F3 + V = Informations sur la version du client',
  ...
  'demo.day.6' => 'Les 5 jours de la démo sont écoulés. Utilisez %s pour prendre une capture d\'écran de votre création.',
  'demo.day.warning' => 'La démo est presque terminée !',
  'demo.demoExpired' => 'Démo terminée !',
  'demo.help.buy' => 'Acheter maintenant !',
  'demo.help.fullWrapped' => 'Cette démo durera 5 jours dans le jeu (soit 1 h 40 en temps réel). Jetez un œil aux progrès pour vous aider ! Bon jeu !',
  ...
  'demo.help.title' => 'Démo de Minecraft',
  ...
  'editGamerule.inGame.button' => 'Règles de jeu...',
  'editGamerule.inGame.disabled.hardcore.tooltip' => 'Impossible de modifier les règles de jeu dans un monde Hardcore.',
  'editGamerule.inGame.disabled.tooltip' => 'La mise à jour des règles de jeu nécessite des permissions d\'opérateur.',
  'editGamerule.inGame.discardChanges.message' => 'Voulez-vous vraiment abandonner les modifications en cours des règles de jeu ?',
  'editGamerule.inGame.discardChanges.title' => 'Modifications des règles de jeu',
  'editGamerule.inGame.downloadingGamerules' => 'Récupération des règles de jeu...',
  ...
  'effect.minecraft.breath_of_the_nautilus' => 'Respiration du nautile',
  ...
  'enchantment.minecraft.lunge' => 'Élan',
  ...
  'entity.minecraft.camel_husk' => 'Dromadaire momifié',
  ...
  'entity.minecraft.parched' => 'Desséché',
  ...
  'entity.minecraft.poplar_boat' => 'Bateau en peuplier',
  'entity.minecraft.poplar_chest_boat' => 'Bateau de stockage en peuplier',
  ...
  'entity.minecraft.sulfur_cube' => 'Cube de soufre',
  'entity.minecraft.sulfur_cube.content' => 'Contient : %s',
  ...
  'entity.minecraft.zombie_nautilus' => 'Nautile-zombie',
  ...
  'filled_map.bamboo_camp_map' => 'Carte de camp de jungle de bambous',
  'filled_map.bamboo_jungle_abandoned_camp' => 'Carte de camp de jungle de bambous',
  'filled_map.birch_forest_abandoned_camp' => 'Carte de camp de forêt de bouleaux',
  'filled_map.birch_forest_camp_map' => 'Carte de camp de forêt de bouleaux',
  'filled_map.buried_treasure' => 'Carte au trésor',
  'filled_map.cherry_grove_abandoned_camp' => 'Carte de camp de bosquet de cerisiers',
  'filled_map.cherry_grove_camp_map' => 'Carte de camp de bosquet de cerisiers',
  'filled_map.dappled_forest_abandoned_camp' => 'Carte de camp de forêt ambrée',
  'filled_map.dappled_forest_camp_map' => 'Carte de camp de forêt ambrée',
  'filled_map.explorer_jungle' => 'Carte d\'exploration des jungles',
  'filled_map.explorer_swamp' => 'Carte d\'exploration des marais',
  'filled_map.flower_forest_abandoned_camp' => 'Carte de camp de forêt fleurie',
  'filled_map.flower_forest_camp_map' => 'Carte de camp de forêt fleurie',
  'filled_map.id' => 'ID #%s',
  'filled_map.jungle_temple' => 'Carte de temple de la jungle',
  ...
  'filled_map.pale_garden_abandoned_camp' => 'Carte de camp de jardin pâle',
  'filled_map.pale_garden_camp_map' => 'Carte de camp de jardin pâle',
  'filled_map.scale' => 'Échelle 1:%s',
  'filled_map.swamp_abandoned_camp' => 'Carte de camp de marais',
  'filled_map.swamp_camp_map' => 'Carte de camp de marais',
  ...
  'filled_map.windswept_forest_abandoned_camp' => 'Carte de camp de forêt venteuse',
  'filled_map.windswept_forest_camp_map' => 'Carte de camp de forêt venteuse',
  ...
  'flat_world_preset.minecraft.overworld' => 'Surface',
  ...
  'gamerule.allowEnteringNetherUsingPortals' => 'Accès au Nether',
  'gamerule.allowEnteringNetherUsingPortals.description' => 'Contrôle si les joueurs peuvent entrer dans le Nether.',
  ...
  'gamerule.commandBlocksEnabled' => 'Blocs de commande activés',
  ...
  'gamerule.enableCommandBlocks' => 'Blocs de commande activés',
  ...
  'gamerule.forgiveDeadPlayers.description' => 'Les créatures neutres en colère redeviennent calmes lorsque le joueur ciblé meurt à proximité.',
  ...
  'gamerule.locatorBar' => 'Barre de localisation',
  'gamerule.locatorBar.description' => 'Si activée, une barre s\'affiche à l\'écran pour indiquer la position des joueurs.',
  ...
  'gamerule.minecraft.elytra_movement_check' => 'Vérification du vol en élytres',
  'gamerule.minecraft.fire_spread_radius_around_player' => 'Rayon de propagation du feu',
  'gamerule.minecraft.fire_spread_radius_around_player.description' => 'Le rayon (en blocs) autour d\'un joueur dans lequel le feu peut se propager.',
  'gamerule.minecraft.player_movement_check' => 'Vérification des mouvements du joueur',
  'gamerule.minecraft.raids' => 'Invasions',
  'gamerule.minecraft.universal_anger.description' => 'Les créatures neutres en colère attaquent n\'importe quel joueur à proximité, pas seulement le joueur qui les a provoquées. Fonctionne mieux lorsque la règle "forgive_dead_players" est désactivée.',
  ...
  'gamerule.pvp' => 'PvP',
  'gamerule.pvp.description' => 'Contrôle si les joueurs peuvent infliger des dégâts aux autres joueurs.',
  ...
  'gamerule.spawnMonsters' => 'Apparition des monstres',
  'gamerule.spawnMonsters.description' => 'Contrôle si les monstres apparaissent naturellement.',
  'gamerule.spawnRadius' => 'Rayon de la zone de réapparition',
  'gamerule.spawnRadius.description' => 'Contrôle la taille de la zone autour du point d\'apparition dans laquelle les joueurs peuvent apparaître.',
  'gamerule.spawnerBlocksEnabled' => 'Générateurs activés',
  ...
  'gamerule.universalAnger.description' => 'Les créatures neutres en colère attaquent n\'importe quel joueur à proximité, pas seulement le joueur qui les a provoquées. Fonctionne mieux lorsque la règle "forgiveDeadPlayers" est désactivée.',
  ...
  'generator.minecraft.flat_all_dimensions' => 'Dimensions plates',
...
Notre équipe l\'examinera dès que possible.',
  ...
  'gui.friends.accept' => 'Accepter',
  'gui.friends.button.loading' => 'Patientez...',
  'gui.friends.button.loading.invite_request_pending' => 'En attente de confirmation',
  'gui.friends.button.loading.join_request_pending' => 'En attente de confirmation',
  'gui.friends.cancel_request' => 'Annuler la demande',
  'gui.friends.confirm_title' => 'Confirmation',
  'gui.friends.confirm_unfriend' => 'Voulez-vous vraiment retirer ce joueur de votre liste d\'amis ?',
  'gui.friends.copy_to_clipboard' => 'Copier',
  'gui.friends.decline' => 'Refuser',
  'gui.friends.empty_nickname' => 'Entrez un nom de profil valide avant d\'envoyer une demande d\'ami',
  'gui.friends.empty_state' => 'Les amis que vous ajoutez apparaîtront ici.

Gérez votre sécurité en ligne avec votre %s.',
  'gui.friends.empty_state.link' => 'compte Microsoft',
  'gui.friends.enter_nickname' => 'Entrez un nom de profil',
  'gui.friends.error.connection_issue' => 'La liste d\'amis ne fonctionne pas pour le moment.

Vérifiez votre connexion Internet puis réessayez.',
  'gui.friends.error.failed.message' => 'Impossible d\'envoyer votre demande d\'ami pour le moment',
  'gui.friends.error.forbidden.message' => 'Échec de l\'action. Cela peut être dû aux paramètres de confidentialité du compte.',
  'gui.friends.error.generic' => 'Quelque chose cloche... avec cette fonctionnalité, pas avec vos amis !

Réessayez plus tard.',
  'gui.friends.error.rateLimited.message' => 'Vous effectuez des actions trop rapidement dans la liste d\'amis. Veuillez patienter un instant puis réessayez.',
  'gui.friends.error.temporary_unavailable' => 'La liste d\'amis ne fonctionne pas pour le moment.

Réessayez plus tard.',
  'gui.friends.error.unauthorized' => 'Jeton non valide fourni. Redémarrez le jeu et le Launcher puis réessayez.',
  'gui.friends.error.unavailable.message' => 'Le service de liste d\'amis est actuellement indisponible. Veuillez vérifier votre connexion puis réessayez plus tard.',
  'gui.friends.error.upgrade_needed' => 'Mettez le jeu à jour pour accéder à votre liste d\'amis.',
  'gui.friends.error.user_may_lack_active_profile' => 'Il n\'y a aucun joueur avec ce nom de profil',
  'gui.friends.join' => 'Rejoindre',
  'gui.friends.loading_friends' => 'Chargement de la liste d\'amis...',
  'gui.friends.loading_requests' => 'Chargement des demandes...',
  'gui.friends.manage_account_footer' => 'Gérez votre sécurité en ligne avec votre %s',
  'gui.friends.multiplayer.invite' => 'Inviter',
  'gui.friends.multiplayer.invite_accept' => 'Accepter',
  'gui.friends.multiplayer.invite_reject' => 'Refuser',
  'gui.friends.multiplayer.join_request' => 'Demander à rejoindre',
  'gui.friends.multiplayer.join_request_accept' => 'Accepter',
  'gui.friends.multiplayer.join_request_reject' => 'Refuser',
  'gui.friends.my_profile_name' => 'Mon nom de profil : ',
  'gui.friends.my_profile_name.narration' => 'Copier le nom de profil %s dans le presse-papiers',
  'gui.friends.narration.button.accept' => 'Appuyez sur Entrée pour accepter la demande d\'ami de %s',
  'gui.friends.narration.button.cancel_request' => 'Appuyez sur Entrée pour annuler la demande d\'ami envoyée à %s',
  'gui.friends.narration.button.decline' => 'Appuyez sur Entrée pour refuser la demande d\'ami de %s',
  'gui.friends.narration.button.unfriend' => 'Appuyez sur Entrée pour retirer %s de la liste d\'amis',
  'gui.friends.narration.entry.friend' => 'Ami %s',
  'gui.friends.narration.entry.incoming' => 'Demande d\'ami reçue de %s',
  'gui.friends.narration.entry.outgoing' => 'Demande d\'ami envoyée à %s',
  'gui.friends.open' => 'Amis',
  'gui.friends.open.narration' => 'Liste d\'amis',
  'gui.friends.open.tooltip' => 'Amis',
  'gui.friends.pending.empty' => 'Aucune demande d\'ami en attente',
  'gui.friends.pending.received' => 'Reçues',
  'gui.friends.pending.sent' => 'Envoyées',
  'gui.friends.presence.status.offline' => 'Hors ligne',
  'gui.friends.presence.status.online' => 'En ligne',
  'gui.friends.presence.status.playing_hosted_server' => 'En ligne (local)',
  'gui.friends.presence.status.playing_offline' => 'En ligne (monde)',
  'gui.friends.presence.status.playing_realms' => 'En ligne (Realm)',
  'gui.friends.presence.status.playing_server' => 'En ligne (serveur)',
  'gui.friends.requests_count' => 'Demandes (%s)',
  'gui.friends.send_request' => 'Envoyer une demande d\'ami',
  'gui.friends.tab_friends' => 'Amis',
  'gui.friends.toast.friend_added.message' => '%s a accepté votre demande d\'ami',
  'gui.friends.toast.friend_invited.message' => 'Vous avez invité %s à rejoindre votre monde',
  'gui.friends.toast.friend_removed.message' => 'Vous avez retiré %s de votre liste d\'amis',
  'gui.friends.toast.generic_error' => 'Une erreur inattendue s\'est produite lors de la mise à jour de votre liste d\'amis. Veuillez réessayer plus tard.',
  'gui.friends.toast.host_invite_expired.message' => 'L\'invitation à rejoindre ce monde envoyée à %s a expiré',
  'gui.friends.toast.invite_from_friend.message' => '%s vous a invité à rejoindre son monde. Ouvrez la liste d\'amis en appuyant sur "%s" pour rejoindre.',
  'gui.friends.toast.join_invite_expired.message' => 'L\'invitation à rejoindre le monde de %s a expiré',
  'gui.friends.toast.join_request.message' => '%s souhaite rejoindre votre monde. Ouvrez la liste d\'amis avec "%s" ou depuis le menu du jeu.',
  'gui.friends.toast.request_accepted.message' => '%s est maintenant dans votre liste d\'amis',
  'gui.friends.toast.request_received.message' => '%s vous a envoyé une demande d\'ami',
  'gui.friends.toast.request_sent.message' => 'Demande d\'ami envoyée à %s',
  'gui.friends.toast.request_to_join_friend.message' => 'Vous avez demandé à rejoindre le monde de %s',
  'gui.friends.toast.requests_accepted_multiple.message' => '%s joueurs ont accepté vos demandes d\'ami',
  'gui.friends.toast.requests_received_multiple.message' => 'Vous avez reçu %s demandes d\'ami',
  'gui.friends.unfriend' => 'Retirer l\'ami',
  'gui.friends.validation.already_friend' => '%s est déjà dans votre liste d\'amis',
  'gui.friends.validation.already_incoming' => '%s vous a déjà envoyé une demande d\'ami',
  'gui.friends.validation.already_outgoing' => 'Vous avez déjà envoyé une demande d\'ami à %s',
  'gui.friends.validation.cannot_add_self' => 'Vous ne pouvez pas vous envoyer de demande d\'ami',
  'gui.game_rule.search' => 'Rechercher...',
  'gui.hours' => '%s heure(s)',
  'gui.language.search' => 'Rechercher...',
  ...
  'gui.packSelection.search' => 'Rechercher...',
  'gui.privacy_link.message' => 'Ouvrez ce lien pour gérer vos paramètres de confidentialité et de sécurité en ligne.',
  'gui.privacy_link.title' => 'Les modifications apportées aux paramètres Xbox peuvent prendre un certain temps à s\'appliquer.

Si elles ne se mettent pas à jour, redémarrez le jeu.',
  'gui.proceed' => 'Continuer',
  'gui.recipebook.moreRecipes' => 'Clic droit pour plus',
  'gui.recipebook.next_page' => 'Page suivante',
  'gui.recipebook.page' => '%s/%s',
  'gui.recipebook.previous_page' => 'Page précédente',
  ...
  'gui.selectWorld.search' => 'Rechercher...',
  ...
  'gui.socialInteractions.tooltip.report.chat_disabled_or_blocked' => 'Ce joueur ne peut pas être signalé car le tchat est désactivé ou bloqué',
  ...
  'gui.stats.none_found' => 'Aucune statistique n\'a été trouvée.',
  ...
  'gui.up' => 'Haut',
  'gui.waitingForResponse.button.inactive' => 'Retour (%s s)',
  'gui.waitingForResponse.title' => 'En attente du serveur',
  'gui.yes' => 'Oui',
  ...
  'item.minecraft.abandoned_camp_map' => 'Carte de camp abandonné',
  'item.minecraft.abandoned_campsite_map' => 'Carte de camp abandonné',
  ...
  'item.minecraft.ancient_city_map' => 'Carte d\'ancienne cité',
  ...
  'item.minecraft.black_cushion' => 'Coussin noir',
  'item.minecraft.black_dye' => 'Teinture noire',
  'item.minecraft.black_harness' => 'Harnais noir',
  ...
  'item.minecraft.blue_cushion' => 'Coussin bleu',
  'item.minecraft.blue_dye' => 'Teinture bleue',
  'item.minecraft.blue_egg' => 'Oeuf bleu',
  'item.minecraft.blue_harness' => 'Harnais bleu',
  ...
  'item.minecraft.brown_cushion' => 'Coussin marron',
  'item.minecraft.brown_dye' => 'Teinture marron',
  'item.minecraft.brown_egg' => 'Oeuf brun',
  'item.minecraft.brown_harness' => 'Harnais marron',
  ...
  'item.minecraft.buried_ancient_city_map' => 'Carte d\'ancienne cité souterraine',
  'item.minecraft.buried_mineshaft_map' => 'Carte de puits de mine souterrain',
  'item.minecraft.buried_treasure_map' => 'Carte au trésor',
  'item.minecraft.buried_trial_chambers_map' => 'Carte de chambres des épreuves souterraines',
  'item.minecraft.burn_pottery_shard' => 'Tesson de poterie de feu',
  'item.minecraft.burn_pottery_sherd' => 'Tesson de poterie de feu',
  'item.minecraft.camel_husk_spawn_egg' => 'Oeuf d\'apparition de dromadaire momifié',
  ...
  'item.minecraft.copper_axe' => 'Hache en cuivre',
  'item.minecraft.copper_boots' => 'Bottes en cuivre',
  'item.minecraft.copper_chestplate' => 'Plastron en cuivre',
  'item.minecraft.copper_golem_spawn_egg' => 'Oeuf d\'apparition de golem de cuivre',
  'item.minecraft.copper_helmet' => 'Casque en cuivre',
  'item.minecraft.copper_hoe' => 'Houe en cuivre',
  'item.minecraft.copper_horse_armor' => 'Armure en cuivre pour cheval',
  'item.minecraft.copper_ingot' => 'Lingot de cuivre',
  'item.minecraft.copper_leggings' => 'Jambières en cuivre',
  'item.minecraft.copper_nautilus_armor' => 'Armure en cuivre pour nautile',
  'item.minecraft.copper_nugget' => 'Pépite de cuivre',
  'item.minecraft.copper_pickaxe' => 'Pioche en cuivre',
  'item.minecraft.copper_shovel' => 'Pelle en cuivre',
  'item.minecraft.copper_spear' => 'Lance en cuivre',
  'item.minecraft.copper_sword' => 'Épée en cuivre',
  ...
  'item.minecraft.cyan_cushion' => 'Coussin cyan',
  'item.minecraft.cyan_dye' => 'Teinture cyan',
  'item.minecraft.cyan_harness' => 'Harnais cyan',
  ...
  'item.minecraft.desert_pyramid_map' => 'Carte de pyramide du désert',
  'item.minecraft.desert_village_map' => 'Carte de village du désert',
  ...
  'item.minecraft.diamond_nautilus_armor' => 'Armure en diamant pour nautile',
  'item.minecraft.diamond_pickaxe' => 'Pioche en diamant',
  'item.minecraft.diamond_shovel' => 'Pelle en diamant',
  'item.minecraft.diamond_spear' => 'Lance en diamant',
  ...
  'item.minecraft.firework_rocket.flight_duration' => 'Durée de vol : %s',
  ...
  'item.minecraft.happy_ghast_spawn_egg' => 'Oeuf d\'apparition de Ghast joyeux',
  'item.minecraft.harness' => 'Harnais',
  ...
  'item.minecraft.husk_spawn_egg' => 'Oeuf d\'apparition de momifié',
  ...
  'item.minecraft.jungle_explorer_map' => 'Carte d\'exploration des jungles',
  'item.minecraft.jungle_pyramid_map' => 'Carte de pyramide de la jungle',
  ...
  'item.minecraft.light_blue_cushion' => 'Coussin bleu clair',
  'item.minecraft.light_blue_dye' => 'Teinture bleu clair',
  'item.minecraft.light_blue_harness' => 'Harnais bleu clair',
  'item.minecraft.light_gray_bundle' => 'Sac gris clair',
  'item.minecraft.light_gray_cushion' => 'Coussin gris clair',
  'item.minecraft.light_gray_dye' => 'Teinture gris clair',
  'item.minecraft.light_gray_harness' => 'Harnais gris clair',
  'item.minecraft.lime_bundle' => 'Sac vert clair',
  'item.minecraft.lime_cushion' => 'Coussin vert clair',
  'item.minecraft.lime_dye' => 'Teinture vert clair',
  'item.minecraft.lime_harness' => 'Harnais vert clair',
  ...
  'item.minecraft.magenta_cushion' => 'Coussin magenta',
  'item.minecraft.magenta_dye' => 'Teinture magenta',
  'item.minecraft.magenta_harness' => 'Harnais magenta',
  ...
  'item.minecraft.mineshaft_map' => 'Carte de puits de mine',
  ...
  'item.minecraft.music_disc_bounce' => 'Disque',
  'item.minecraft.music_disc_bounce.desc' => 'fingerspit - Bounce',
  ...
  'item.minecraft.music_disc_lava_chicken' => 'Disque',
  ...
  'item.minecraft.music_disc_tears' => 'Disque',
  ...
  'item.minecraft.nautilus_spawn_egg' => 'Oeuf d\'apparition de nautile',
  ...
  'item.minecraft.netherite_horse_armor' => 'Armure en netherite pour cheval',
  'item.minecraft.netherite_ingot' => 'Lingot de netherite',
  'item.minecraft.netherite_leggings' => 'Jambières en netherite',
  'item.minecraft.netherite_nautilus_armor' => 'Armure en netherite pour nautile',
  ...
  'item.minecraft.netherite_spear' => 'Lance en netherite',
  ...
  'item.minecraft.ocean_explorer_map' => 'Carte d\'exploration des océans',
  'item.minecraft.ocean_monument_map' => 'Carte de monument océanique',
  ...
  'item.minecraft.orange_cushion' => 'Coussin orange',
  'item.minecraft.orange_dye' => 'Teinture orange',
  'item.minecraft.orange_harness' => 'Harnais orange',
  ...
  'item.minecraft.parched_spawn_egg' => 'Oeuf d\'apparition de desséché',
  ...
  'item.minecraft.pink_cushion' => 'Coussin rose',
  'item.minecraft.pink_dye' => 'Teinture rose',
  'item.minecraft.pink_harness' => 'Harnais rose',
  'item.minecraft.pitcher_plant' => 'Planturne',
  'item.minecraft.pitcher_pod' => 'Gousse de planturne',
  'item.minecraft.plains_village_map' => 'Carte de village des plaines',
  ...
  'item.minecraft.poplar_boat' => 'Bateau en peuplier',
  'item.minecraft.poplar_chest_boat' => 'Bateau de stockage en peuplier',
  ...
  'item.minecraft.purple_cushion' => 'Coussin violet',
  'item.minecraft.purple_dye' => 'Teinture violette',
  'item.minecraft.purple_harness' => 'Harnais violet',
  ...
  'item.minecraft.red_cushion' => 'Coussin rouge',
  'item.minecraft.red_dye' => 'Teinture rouge',
  'item.minecraft.red_harness' => 'Harnais rouge',
  ...
  'item.minecraft.savanna_village_map' => 'Carte de village de la savane',
  ...
  'item.minecraft.snowy_village_map' => 'Carte de village des neiges',
  ...
  'item.minecraft.stone_spear' => 'Lance en pierre',
  'item.minecraft.stone_sword' => 'Épée en pierre',
  'item.minecraft.straw_bed' => 'Lit de paille',
  ...
  'item.minecraft.sulfur_cube_bucket' => 'Cube de soufre dans un seau',
  'item.minecraft.sulfur_cube_spawn_egg' => 'Oeuf d\'apparition de cube de soufre',
  'item.minecraft.suspicious_stew' => 'Soupe suspecte',
  'item.minecraft.swamp_explorer_map' => 'Carte d\'exploration des marais',
  'item.minecraft.swamp_hut_map' => 'Carte de cabane des marais',
  ...
  'item.minecraft.taiga_village_map' => 'Carte de village de la taïga',
  ...
  'item.minecraft.trial_explorer_map' => 'Carte de chambres des épreuves',
  ...
  'item.minecraft.warm_ocean_ruins_map' => 'Carte de ruines océaniques chaudes',
  ...
  'item.minecraft.white_cushion' => 'Coussin blanc',
  'item.minecraft.white_dye' => 'Teinture blanche',
  'item.minecraft.white_harness' => 'Harnais blanc',
  ...
  'item.minecraft.wooden_spear' => 'Lance en bois',
  'item.minecraft.wooden_sword' => 'Épée en bois',
  'item.minecraft.woodland_explorer_map' => 'Carte d\'exploration des bois',
  'item.minecraft.woodland_mansion_map' => 'Carte de manoir des bois',
  'item.minecraft.writable_book' => 'Livre et plume',
  'item.minecraft.written_book' => 'Livre écrit',
  'item.minecraft.yellow_bundle' => 'Sac jaune',
  'item.minecraft.yellow_cushion' => 'Coussin jaune',
  'item.minecraft.yellow_dye' => 'Teinture jaune',
  'item.minecraft.yellow_harness' => 'Harnais jaune',
  ...
  'item.minecraft.zombie_nautilus_spawn_egg' => 'Oeuf d\'apparition de nautile-zombie',
  ...
  'item.op_block_warning.line2' => 'Placer cet objet pourrait entraîner l\'exécution d\'une commande.',
  'item.op_block_warning.line3' => 'Ne pas utiliser à moins d\'en connaître le contenu exact !',
  'item.spawn_egg.peaceful' => 'Désactivé en Paisible',
...
Le processus se déroule dans l\'ordre décroissant, ou de manière aléatoire en cas d\'égalité.',
  ...
  'jukebox_song.minecraft.bounce' => 'fingerspit - Bounce',
  ...
  'key.categories.spectator' => 'Mode Spectateur',
  'key.categories.ui' => 'Interface de jeu',
  'key.category.minecraft.creative' => 'Mode Créatif',
  'key.category.minecraft.debug' => 'Débogage',
  'key.category.minecraft.gameplay' => 'Gameplay',
  'key.category.minecraft.inventory' => 'Inventaire',
  'key.category.minecraft.misc' => 'Divers',
  'key.category.minecraft.movement' => 'Mouvements',
  'key.category.minecraft.multiplayer' => 'Multijoueur',
  'key.category.minecraft.spectator' => 'Mode Spectateur',
  'key.chat' => 'Ouvrir le tchat',
  'key.command' => 'Entrer une commande',
  'key.debug.clearChat' => 'Effacer le tchat',
  'key.debug.copyLocation' => 'Copier la position',
  'key.debug.copyRecreateCommand' => 'Copier les données',
  'key.debug.crash' => 'Faire planter le jeu',
  'key.debug.debugOptions' => 'Paramètres de débogage',
  'key.debug.dumpDynamicTextures' => 'Exporter les textures dynamiques',
  'key.debug.dumpVersion' => 'Afficher les informations de version',
  'key.debug.focusPause' => 'Mettre en pause à la perte de focus',
  'key.debug.fpsCharts' => 'Graphiques des FPS',
  'key.debug.improvedTransparency' => 'Basculer la transparence améliorée',
  'key.debug.lightmapTexture' => 'Texture de la lightmap',
  'key.debug.modifier' => 'Touche de modification de débogage',
  'key.debug.networkCharts' => 'Graphiques de réseau',
  'key.debug.overlay' => 'Basculer l\'overlay',
  'key.debug.profiling' => 'Démarrer/arrêter le profilage',
  'key.debug.profilingChart' => 'Graphique de profilage',
  'key.debug.reloadChunk' => 'Recharger les chunks',
  'key.debug.reloadResourcePacks' => 'Recharger les packs de ressources',
  'key.debug.showAdvancedTooltips' => 'Afficher les info-bulles avancées',
  'key.debug.showChunkBorders' => 'Afficher les bordures des chunks',
  'key.debug.showHitboxes' => 'Afficher les boîtes de collision',
  'key.debug.spectate' => 'Alterner le mode Spectateur',
  'key.debug.switchGameMode' => 'Sélecteur de mode de jeu',
  'key.drop' => 'Jeter l\'objet sélectionné',
  'key.forward' => 'Avancer',
  'key.friends' => 'Liste d\'amis',
  ...
  'key.jump' => 'Sauter',
  'key.keyboard.ac.back' => 'Retour (CA)',
  'key.keyboard.ac.bookmarks' => 'Favoris (CA)',
  'key.keyboard.ac.close' => 'Fermer (CA)',
  'key.keyboard.ac.exit' => 'Quitter (CA)',
  'key.keyboard.ac.forward' => 'Suivant (CA)',
  'key.keyboard.ac.home' => 'Début (CA)',
  'key.keyboard.ac.new' => 'Nouveau (CA)',
  'key.keyboard.ac.open' => 'Ouvrir (CA)',
  'key.keyboard.ac.print' => 'Imprimer (CA)',
  'key.keyboard.ac.properties' => 'Propriétés (CA)',
  'key.keyboard.ac.refresh' => 'Actualiser (CA)',
  'key.keyboard.ac.save' => 'Sauvegarder (CA)',
  'key.keyboard.ac.search' => 'Rechercher (CA)',
  'key.keyboard.ac.stop' => 'Arrêter (CA)',
  'key.keyboard.again' => 'Répéter',
  'key.keyboard.alternate.erase' => 'Effacer alt.',
  'key.keyboard.apostrophe' => '\'',
  'key.keyboard.application' => 'Menu',
  'key.keyboard.backslash' => '\\',
  'key.keyboard.backspace' => 'Retour arrière',
  'key.keyboard.call' => 'Appeler',
  'key.keyboard.cancel' => 'Annuler',
  'key.keyboard.caps.lock' => 'Ver. maj.',
  'key.keyboard.channel.down' => 'CH -',
  'key.keyboard.channel.up' => 'CH +',
  'key.keyboard.clear' => 'Effacer',
  'key.keyboard.clear.again' => 'Effacer/Répéter',
  'key.keyboard.comma' => ',',
  'key.keyboard.copy' => 'Copier',
  'key.keyboard.crsel' => 'CrSel',
  'key.keyboard.currency.subunit' => 'Sous-unité monétaire',
  'key.keyboard.currency.unit' => 'Unité monétaire',
  'key.keyboard.cut' => 'Couper',
  'key.keyboard.decimal.separator' => 'Séparateur décimal',
  'key.keyboard.delete' => 'Suppr',
  'key.keyboard.down' => 'Flèche bas',
  'key.keyboard.end' => 'Fin',
  'key.keyboard.end.call' => 'Raccrocher',
  'key.keyboard.enter' => 'Entrée',
  'key.keyboard.enter2' => 'Entrée 2',
  'key.keyboard.equal' => '=',
  'key.keyboard.escape' => 'Échap',
  'key.keyboard.execute' => 'Exécuter',
  'key.keyboard.exsel' => 'ExSel',
  'key.keyboard.f1' => 'F1',
  ...
  'key.keyboard.f8' => 'F8',
  'key.keyboard.f9' => 'F9',
  'key.keyboard.find' => 'Rechercher',
  'key.keyboard.grave.accent' => '`',
  'key.keyboard.help' => 'Aide',
  'key.keyboard.home' => 'Début',
  'key.keyboard.insert' => 'Inser',
  'key.keyboard.international1' => 'International 1',
  'key.keyboard.international2' => 'International 2',
  'key.keyboard.international3' => 'International 3',
  'key.keyboard.international4' => 'International 4',
  'key.keyboard.international5' => 'International 5',
  'key.keyboard.international6' => 'International 6',
  'key.keyboard.international7' => 'International 7',
  'key.keyboard.international8' => 'International 8',
  'key.keyboard.international9' => 'International 9',
  'key.keyboard.keypad.0' => '0 pavé num.',
  'key.keyboard.keypad.00' => '00 pavé num.',
  'key.keyboard.keypad.000' => '000 pavé num.',
  ...
  'key.keyboard.keypad.a' => 'A pavé num.',
  'key.keyboard.keypad.add' => '+ pavé num.',
  'key.keyboard.keypad.ampersand' => '& pavé num.',
  'key.keyboard.keypad.at' => '@ pavé num.',
  'key.keyboard.keypad.b' => 'B pavé num.',
  'key.keyboard.keypad.backspace' => 'Retour arrière pavé num.',
  'key.keyboard.keypad.binary' => 'Binaire pavé num.',
  'key.keyboard.keypad.c' => 'C pavé num.',
  'key.keyboard.keypad.clear' => 'Effacer pavé num.',
  'key.keyboard.keypad.clear.entry' => 'CE pavé num.',
  'key.keyboard.keypad.colon' => ': pavé num.',
  'key.keyboard.keypad.comma' => ', pavé num.',
  'key.keyboard.keypad.d' => 'D pavé num.',
  'key.keyboard.keypad.decimal' => 'Point pavé num.',
  'key.keyboard.keypad.divide' => '/ pavé num.',
  'key.keyboard.keypad.double.ampersand' => '&& pavé num.',
  'key.keyboard.keypad.double.vertical.bar' => '|| pavé num.',
  'key.keyboard.keypad.e' => 'E pavé num.',
  'key.keyboard.keypad.enter' => 'Entrée pavé num.',
  'key.keyboard.keypad.equal' => '= pavé num.',
  'key.keyboard.keypad.equals.as400' => '= pavé num. (AS400)',
  'key.keyboard.keypad.exclamation' => '! pavé num.',
  'key.keyboard.keypad.f' => 'F pavé num.',
  'key.keyboard.keypad.greater' => '> pavé num.',
  'key.keyboard.keypad.hash' => '# pavé num.',
  'key.keyboard.keypad.hexadecimal' => 'Hexadécimal pavé num.',
  'key.keyboard.keypad.left.brace' => '{ pavé num.',
  'key.keyboard.keypad.left.parenthesis' => '( pavé num.',
  'key.keyboard.keypad.less' => '< pavé num.',
  'key.keyboard.keypad.memory.add' => 'M+ pavé num.',
  'key.keyboard.keypad.memory.clear' => 'MC pavé num.',
  'key.keyboard.keypad.memory.divide' => 'M/ pavé num.',
  'key.keyboard.keypad.memory.multiply' => 'M* pavé num.',
  'key.keyboard.keypad.memory.recall' => 'MR pavé num.',
  'key.keyboard.keypad.memory.store' => 'MS pavé num.',
  'key.keyboard.keypad.memory.subtract' => 'M- pavé num.',
  'key.keyboard.keypad.multiply' => '* pavé num.',
  'key.keyboard.keypad.octal' => 'Octal pavé num.',
  'key.keyboard.keypad.percent' => '%% pavé num.',
  'key.keyboard.keypad.period' => '. pavé num.',
  'key.keyboard.keypad.plus.minus' => '± pavé num.',
  'key.keyboard.keypad.power' => '^ pavé num.',
  'key.keyboard.keypad.right.brace' => '} pavé num.',
  'key.keyboard.keypad.right.parenthesis' => ') pavé num.',
  'key.keyboard.keypad.space' => 'Espace pavé num.',
  'key.keyboard.keypad.subtract' => '- pavé num.',
  'key.keyboard.keypad.tab' => 'Tab pavé num.',
  'key.keyboard.keypad.vertical.bar' => '| pavé num.',
  'key.keyboard.keypad.xor' => 'XOR pavé num.',
  'key.keyboard.lang1' => 'Langue 1',
  'key.keyboard.lang2' => 'Langue 2',
  'key.keyboard.lang3' => 'Langue 3',
  'key.keyboard.lang4' => 'Langue 4',
  'key.keyboard.lang5' => 'Langue 5',
  'key.keyboard.lang6' => 'Langue 6',
  'key.keyboard.lang7' => 'Langue 7',
  'key.keyboard.lang8' => 'Langue 8',
  'key.keyboard.lang9' => 'Langue 9',
  'key.keyboard.left' => 'Flèche gauche',
  'key.keyboard.left.alt' => 'Alt',
  'key.keyboard.left.bracket' => '[',
  'key.keyboard.left.command' => 'Commande gauche',
  'key.keyboard.left.control' => 'Ctrl gauche',
  'key.keyboard.left.meta' => 'Méta gauche',
  'key.keyboard.left.option' => 'Option gauche',
  'key.keyboard.left.shift' => 'Maj. gauche',
  'key.keyboard.left.win' => 'Win gauche',
  'key.keyboard.left.windows' => 'Windows gauche',
  'key.keyboard.media.eject' => 'Éjecter',
  'key.keyboard.media.fast.forward' => 'Avance rapide',
  'key.keyboard.media.next.track' => 'Piste suivante',
  'key.keyboard.media.pause' => 'Pause média',
  'key.keyboard.media.play' => 'Lecture média',
  'key.keyboard.media.play.pause' => 'Lecture/Pause',
  'key.keyboard.media.previous.track' => 'Piste précédente',
  'key.keyboard.media.record' => 'Enregistrer',
  'key.keyboard.media.rewind' => 'Rembobiner',
  'key.keyboard.media.select' => 'Sélectionner le média',
  'key.keyboard.media.stop' => 'Stop média',
  'key.keyboard.menu' => 'Menu',
  'key.keyboard.minus' => '-',
  'key.keyboard.mode' => 'Mode',
  'key.keyboard.mute' => 'Muet',
  'key.keyboard.new' => 'Nouveau',
  'key.keyboard.num.lock' => 'Ver. num.',
  'key.keyboard.oper' => 'Oper',
  'key.keyboard.out' => 'Sortie',
  'key.keyboard.page.down' => 'Page suiv.',
  'key.keyboard.page.up' => 'Page préc.',
  'key.keyboard.paste' => 'Coller',
  'key.keyboard.pause' => 'Pause',
  'key.keyboard.period' => '.',
  'key.keyboard.power' => 'Power',
  'key.keyboard.print.screen' => 'Impr. écran',
  'key.keyboard.prior' => 'Précédent',
  'key.keyboard.right' => 'Flèche droite',
  'key.keyboard.right.alt' => 'Alt Gr',
  'key.keyboard.right.bracket' => ']',
  'key.keyboard.right.command' => 'Commande droite',
  'key.keyboard.right.control' => 'Ctrl droite',
  'key.keyboard.right.meta' => 'Méta droite',
  'key.keyboard.right.option' => 'Option droite',
  'key.keyboard.right.shift' => 'Maj. droite',
  'key.keyboard.right.win' => 'Win droite',
  'key.keyboard.right.windows' => 'Windows droite',
  'key.keyboard.save' => 'Sauvegarder',
  'key.keyboard.scroll.lock' => 'Arrêt défil.',
  'key.keyboard.select' => 'Sélectionner',
  'key.keyboard.semicolon' => ';',
  'key.keyboard.separator' => 'Séparateur',
  'key.keyboard.slash' => '/',
  'key.keyboard.sleep' => 'Veille',
  'key.keyboard.soft.left' => 'Fonction gauche',
  'key.keyboard.soft.right' => 'Fonction droite',
  'key.keyboard.space' => 'Espace',
  'key.keyboard.stop' => 'Arrêter',
  'key.keyboard.sys.req' => 'Syst',
  'key.keyboard.tab' => 'Tab',
  'key.keyboard.thousands.separator' => 'Séparateur de milliers',
  'key.keyboard.undo' => 'Annuler',
  'key.keyboard.unknown' => 'Non assignée',
  'key.keyboard.up' => 'Flèche haut',
  'key.keyboard.volume.down' => 'Volume -',
  'key.keyboard.volume.up' => 'Volume +',
  'key.keyboard.wake' => 'Éveil',
...
Laissez le champ de saisie vide ou entrez un numéro différent compris entre %s et %s.',
  ...
  'loading.progress' => '%s %%',
  'manageServer.add.title' => 'Ajout d\'un serveur',
  'manageServer.edit.title' => 'Modification des informations du serveur',
  'manageServer.enterIp' => 'Adresse du serveur',
  'manageServer.enterName' => 'Nom du serveur',
  'manageServer.resourcePack' => 'Packs de ressources du serveur',
  'manageServer.resourcePack.disabled' => 'Désactivés',
  'manageServer.resourcePack.enabled' => 'Activés',
  'manageServer.resourcePack.prompt' => 'Demander',
...
Si vous possédez un ancien compte Minecraft (si vous vous connectez avec votre nom d\'utilisateur), vous devez migrer votre compte vers un compte Mojang pour accéder à Realms.',
  ...
  'mco.backup.button.reset' => 'Réinitialiser le monde',
  ...
  'mco.backup.entry.worldType.adventureMap' => 'Aventure',
  'mco.backup.entry.worldType.experience' => 'Expérience',
  'mco.backup.entry.worldType.inspiration' => 'Inspiration',
  'mco.backup.entry.worldType.minigame' => 'Mini-jeu',
  'mco.backup.entry.worldType.normal' => 'Normal',
  'mco.backup.entry.worldType.unknown' => 'Inconnu',
...
Le propriétaire du Realm peut restaurer le monde si nécessaire.',
  ...
  'mco.configure.world.backup' => 'Sauvegardes du monde',
  'mco.configure.world.buttons.activity' => 'Activité des joueurs',
  'mco.configure.world.buttons.close' => 'Fermer temporairement le Realm',
  ...
  'mco.configure.world.buttons.invite_codes' => 'Codes d\'invitation',
  'mco.configure.world.buttons.moreoptions' => 'Plus d\'options',
  'mco.configure.world.buttons.newworld' => 'Nouveau monde',
  'mco.configure.world.buttons.open' => 'Rouvrir le Realm',
  'mco.configure.world.buttons.options' => 'Options du monde',
  'mco.configure.world.buttons.players' => 'Joueurs',
  'mco.configure.world.buttons.region_preference' => 'Sélectionner une région...',
  'mco.configure.world.buttons.resetworld' => 'Réinitialiser',
  'mco.configure.world.buttons.save' => 'Sauvegarder',
  ...
  'mco.configure.world.close.question.line1' => 'Vous pouvez fermer temporairement votre Realm afin que personne ne puisse jouer pendant que vous apportez des modifications. Ouvrez-le à nouveau lorsque vous aurez fini. 

Cela n\'annulera pas votre abonnement à Realms.',
  'mco.configure.world.close.question.line2' => 'Voulez-vous vraiment continuer ?',
  'mco.configure.world.close.question.title' => 'Besoin d\'apporter des modifications sans interruption ?',
  'mco.configure.world.closing' => 'Fermeture temporaire du Realm...',
  ...
  'mco.configure.world.invite_codes.copy' => 'Copier',
  'mco.configure.world.invite_codes.create' => 'Créer un code d\'invitation',
  'mco.configure.world.invite_codes.delete' => 'Supprimer',
  'mco.configure.world.invite_codes.edit' => 'Modifier',
  'mco.configure.world.invite_codes.edit.active' => 'Actif',
  'mco.configure.world.invite_codes.edit.expiration_date' => 'Date d\'expiration',
  'mco.configure.world.invite_codes.edit.expires' => 'Expiration : %s',
  'mco.configure.world.invite_codes.edit.title' => 'Modification du code d\'invitation',
  'mco.configure.world.invite_codes.expiration.12_hours' => '12 heures',
  'mco.configure.world.invite_codes.expiration.1_day' => '1 jour',
  'mco.configure.world.invite_codes.expiration.1_hour' => '1 heure',
  'mco.configure.world.invite_codes.expiration.30_minutes' => '30 minutes',
  'mco.configure.world.invite_codes.expiration.6_hours' => '6 heures',
  'mco.configure.world.invite_codes.expiration.7_days' => '7 jours',
  'mco.configure.world.invite_codes.expiration.never' => 'Jamais',
  'mco.configure.world.invite_codes.loading' => 'Chargement des codes d\'invitation',
  'mco.configure.world.invite_codes.subtitle' => 'Vous pouvez créer jusqu\'à %s codes d\'invitation et les partager avec d\'autres joueurs pour qu\'ils rejoignent votre Realm',
  'mco.configure.world.invite_codes.title' => 'Codes d\'invitation (%s/%s)',
  ...
  'mco.configure.world.loading' => 'Chargement du Realm',
  'mco.configure.world.location' => 'Emplacement',
  'mco.configure.world.minigame' => 'Actuel : %s',
  'mco.configure.world.name' => 'Nom du Realm',
  'mco.configure.world.name.validation.whitespace' => 'Ne doit pas commencer ou finir par un espace blanc. Sinon, il sera supprimé.',
  'mco.configure.world.opening' => 'Ouverture du Realm...',
  'mco.configure.world.players.error' => 'Il n\'existe aucun joueur avec ce nom',
  'mco.configure.world.players.invite.duplicate' => 'Un joueur avec ce nom a déjà été invité au Realm',
  'mco.configure.world.players.inviting' => 'Envoi de l\'invitation...',
  'mco.configure.world.players.title' => 'Joueurs',
  'mco.configure.world.pvp' => 'PVP',
  'mco.configure.world.region_preference' => 'Préférence de région',
  'mco.configure.world.region_preference.title' => 'Sélection de la préférence de région',
  'mco.configure.world.renderDistance' => 'Limite de la distance d\'affichage',
  'mco.configure.world.renderDistance.tooltip' => 'La distance maximale visible par les membres du Realm. Des valeurs élevées peuvent affecter les performances.',
...
Voulez-vous le télécharger pour jouer ?',
  ...
  'mco.configure.world.settings.expired' => 'Vous ne pouvez pas modifier les paramètres d\'un Realm expiré',
  'mco.configure.world.settings.title' => 'Paramètres',
  'mco.configure.world.simulationDistance' => 'Distance de simulation',
  'mco.configure.world.simulationDistance.tooltip' => 'La zone autour des joueurs dans laquelle le jeu charge et applique les modifications.',
  ...
  'mco.configure.world.subscription.tab' => 'Abonnement',
  ...
  'mco.connect.region' => 'Région du serveur : %s',
...
Vous ne pourrez plus envoyer ce monde sur votre Realm',
  ...
  'mco.errorMessage.realmsService.configurationError' => 'Une erreur inattendue s\'est produite lors de la modification des options du monde',
...
Rendez-vous sur votre profil sur minecraft.net pour transférer votre abonnement.',
  ...
  'mco.pdp.friends.description' => 'Les amis que vous invitez peuvent jouer gratuitement dans votre Realm à tout moment, même quand vous n\'êtes pas en ligne. Jouez jusqu\'à 10 en même temps !',
  'mco.pdp.friends.title' => 'Une meilleure façon de jouer ensemble',
  'mco.pdp.minigames.description' => 'Explorez une collection sans cesse renouvelée de mini-jeux, de cartes d\'aventure et plus encore.',
  'mco.pdp.minigames.title' => 'Mini-jeux - Contenu gratuit de créateurs',
  'mco.pdp.private.backups' => '• Sauvegardes automatiques',
  'mco.pdp.private.easyToManage' => '• Facile à configurer et à gérer',
  'mco.pdp.private.secure' => '• Privé et sécurisé',
  'mco.pdp.private.title' => 'Serveur personnel',
  'mco.pdp.private.worldSlots' => 'Trois emplacements de monde',
  'mco.pdp.trial.description' => '30 jours d\'essai gratuit !',
  'mco.pdp.trial.title' => 'Votre propre serveur, toujours en ligne',
  'mco.pdp.tryForFree' => 'Essayer gratuitement',
  'mco.play.button.realm.closed' => 'Le Realm est fermé',
  ...
  'mco.selectServer.closed' => 'Realm désactivé',
  ...
  'mco.selectServer.freeTrial' => 'Essai gratuit',
  'mco.selectServer.joinCode' => 'Code d\'accès',
  'mco.selectServer.joinCode.hint' => 'Entrer un code d\'accès',
  'mco.selectServer.joinCode.invalid' => 'Le code entré n\'est pas valide.',
  'mco.selectServer.joinCode.select' => 'Rejoindre le Realm',
  'mco.selectServer.joinCode.title' => 'Entrez un code d\'accès',
  'mco.selectServer.joinCode.validating' => 'Validation du code',
  'mco.selectServer.joinRealm' => 'Rejoindre',
...
Vous pouvez accéder à vos Realms normaux dans la version officielle du jeu.',
  'mco.snapshotRealmsPopup.message' => 'Realms est maintenant disponible dans les snapshots à partir de la 23w41a. Chaque abonnement à Realms inclut un Realm de snapshot gratuit qui est distinct de votre Realm Java habituel !',
  'mco.snapshotRealmsPopup.title' => 'Realms est maintenant disponible dans les snapshots',
...
%s.',
  ...
  'mco.upload.select.world.none' => 'Aucun monde solo n\'a été trouvé !',
  ...
  'menu.custom_options' => 'Personnalisation...',
  'menu.custom_options.title' => 'Options personnalisées',
  'menu.custom_options.tooltip' => 'Remarque : les options personnalisées sont fournies par des serveurs et/ou du contenu tiers.
Faites attention !',
  'menu.custom_screen_info.button_narration' => 'Ceci est un écran personnalisé. En savoir plus.',
  'menu.custom_screen_info.contents' => 'Le contenu de cet écran est contrôlé par des serveurs et des cartes tiers qui ne sont pas détenus, exploités ou supervisés par Mojang Studios ou Microsoft.

Attention ! Faites preuve de prudence lorsque vous suivez des liens et ne partagez jamais vos informations personnelles, y compris vos détails de connexion.

Si cet écran vous empêche de jouer, vous pouvez également vous déconnecter du serveur actuel en utilisant le bouton ci-dessous.',
  'menu.custom_screen_info.disconnect' => 'Écran personnalisé rejeté',
  'menu.custom_screen_info.title' => 'Remarque à propos des écrans personnalisés',
  'menu.custom_screen_info.tooltip' => 'Ceci est un écran personnalisé. Cliquez ici pour en savoir plus.',
  ...
  'menu.multiplayerOptions.applyChanges' => 'Appliquer les modifications',
  'menu.multiplayerOptions.button' => 'Réseau local...',
  'menu.multiplayerOptions.lan' => 'Réseau local',
  'menu.multiplayerOptions.network' => 'Multijoueur',
  'menu.multiplayerOptions.network.header' => 'Réseau',
  'menu.multiplayerOptions.network.lan' => 'Réseau local',
  'menu.multiplayerOptions.network.lan.tooltip' => 'Les joueurs sur le même réseau peuvent rejoindre le monde.',
  'menu.multiplayerOptions.network.off' => 'Non',
  'menu.multiplayerOptions.network.off.tooltip' => 'Personne ne peut rejoindre le monde.',
  'menu.multiplayerOptions.network.online' => 'En ligne',
  'menu.multiplayerOptions.network.online.tooltip' => 'Les amis en ligne peuvent rejoindre le monde.',
  'menu.multiplayerOptions.otherPlayers.header' => 'Paramètres pour les autres joueurs',
  'menu.multiplayerOptions.publish.started.lan' => 'Ce monde est maintenant ouvert au réseau local. Le numéro de port est %s',
  'menu.multiplayerOptions.publish.started.online' => 'Ce monde est maintenant ouvert au multijoueur en ligne.',
  'menu.multiplayerOptions.publish.stopped' => 'Ce monde n\'est plus ouvert au multijoueur',
  'menu.multiplayerOptions.title' => 'Options de réseau local',
  'menu.online' => 'Minecraft Realms',
  'menu.options' => 'Options...',
  'menu.paused' => 'Jeu en pause',
  'menu.playdemo' => 'Jouer dans le monde de démo',
  'menu.playerReporting' => 'Signaler le tchat',
  'menu.playerReporting.no_players' => 'Il n\'y a aucun joueur à signaler dans ce monde',
  'menu.preparingSpawn' => 'Préparation de la zone d\'apparition : %s %%',
  'menu.quick_actions' => 'Actions rapides...',
  ...
  'mount.sit' => 'Appuyez sur %1$s pour vous lever',
  'multiplayer.applyingPack' => 'Application du pack de ressources...',
  'multiplayer.codeOfConduct.check' => 'Ne plus m\'avertir de ce code de conduite',
  'multiplayer.codeOfConduct.title' => 'Code de conduite du serveur',
  'multiplayer.confirm_command.parse_errors' => 'Vous êtes sur le point d\'exécuter une commande non reconnue ou non valide.
Voulez-vous continuer ?
Commande : %s',
  'multiplayer.confirm_command.permissions_required' => 'Vous êtes sur le point d\'exécuter une commande qui nécessite des permissions élevées.
Cela pourrait affecter négativement votre partie.
Voulez-vous continuer ?
Commande : %s',
  'multiplayer.confirm_command.run_command' => 'Exécuter la commande',
  'multiplayer.confirm_command.signature_required' => 'Vous êtes sur le point d\'exécuter une commande qui enverra des messages dans le tchat à votre nom.
Elle ne peut être exécutée qu\'à partir du tchat.
Commande : %s',
  'multiplayer.confirm_command.suggest_command' => 'Copier dans le tchat',
  'multiplayer.confirm_command.title' => 'Confirmation de l\'exécution d\'une commande',
  ...
  'multiplayer.disconnect.bad_chat_index' => 'Un message manquant ou réordonné reçu de la part du serveur a été détecté',
...
Raison : %s',
  'multiplayer.disconnect.banned.reason.default' => 'Banni(e) par un opérateur',
...
Raison : %s',
  ...
  'multiplayer.disconnect.code_of_conduct' => 'Le serveur exige l\'acceptation du code de conduite',
  'multiplayer.disconnect.configuration_error' => 'Erreur inattendue durant la configuration',
...
Veuillez contacter l\'opérateur du serveur.',
  ...
  'multiplayer.disconnect.transfers_disabled' => 'Ce serveur n\'accepte pas les transferts',
  'multiplayer.disconnect.unexpected_query_response' => 'Données personnalisées inattendues de la part du client',
  'multiplayer.disconnect.unsigned_chat' => 'Un paquet de tchat avec une signature manquante ou non valide a été reçu.',
  ...
  'multiplayer.status.anonymous_player' => 'Joueur anonyme',
...
%s',
  ...
  'music.game.home' => 'fingerspit - Home',
  ...
  'music.game.memories' => 'fingerspit - Memories',
  ...
  'music.game.nightly' => 'fingerspit - Nightly',
  ...
  'music.game.shores' => 'fingerspit - Shores',
  ...
  'narration.checkbox.usage.focused.check' => 'Appuyez sur Entrée pour cocher',
  'narration.checkbox.usage.focused.uncheck' => 'Appuyez sur Entrée pour décocher',
  'narration.checkbox.usage.hovered' => 'Faites un clic gauche pour alterner',
  'narration.checkbox.usage.hovered.check' => 'Faites un clic gauche pour cocher',
  'narration.checkbox.usage.hovered.uncheck' => 'Faites un clic gauche pour décocher',
  ...
  'narration.item' => 'Objet : %s',
  'narration.link.usage.focused' => 'Appuyez sur Entrée pour suivre le lien',
  'narration.link.usage.hovered' => 'Faites un clic gauche pour suivre le lien',
  ...
  'narration.selection.usage' => 'Appuyez sur les touches haut et bas pour changer la sélection',
  'narration.slider.usage.focused' => 'Appuyez sur les touches gauche et droite pour changer la valeur',
  'narration.slider.usage.focused.keyboard_cannot_change_value' => 'Appuyez sur Entrée pour commencer à changer la valeur du curseur',
  'narration.slider.usage.hovered' => 'Faites glisser le curseur pour changer sa valeur',
  ...
  'optimizeWorld.confirm.title' => 'Optimisation du monde',
  ...
  'options.accessibility.tooltip' => 'Options d\'accessibilité',
  'options.allowCursorChanges' => 'Changements du curseur',
  'options.allowCursorChanges.tooltip' => 'Permet au curseur de la souris de changer de forme au-dessus de certains éléments de l\'interface.',
  'options.allowFriendRequests' => 'Autoriser les demandes',
  'options.allowFriendRequests.tooltip' => 'Autorise les autres joueurs à vous envoyer des demandes d\'ami.',
...
Si cette option est désactivée, votre nom n\'apparaîtra pas dans ces listes.',
  ...
  'options.blocks' => '%s blocs',
  'options.chat' => 'Tchat...',
  'options.chat.color' => 'Couleurs',
  'options.chat.delay' => 'Délai du tchat : %s s',
  'options.chat.delay_none' => 'Délai du tchat : Aucun',
  'options.chat.drafts' => 'Sauvegarder les brouillons',
  'options.chat.drafts.tooltip' => 'Les messages non envoyés seront sauvegardés et pourront être envoyés à la prochaine ouverture du tchat.',
  ...
  'options.chat.title' => 'Options du tchat',
  ...
  'options.chunkFade' => 'Temps de fondu des chunks',
  'options.chunkFade.none' => 'Fondu des chunks : Non',
  'options.chunkFade.seconds' => 'Fondu des chunks : %s s',
  'options.chunkFade.tooltip' => 'La durée en secondes de l\'apparition en fondu des chunks lorsqu\'ils s\'affichent pour la première fois.',
  ...
  'options.ctrlClickEmulatesRightClick' => 'Émulation du clic droit',
  'options.ctrlClickEmulatesRightClick.tooltip' => 'Si activée, Ctrl + clic gauche est traitée comme un clic droit. S\'applique uniquement sur macOS.',
  'options.cutoutLeaves' => 'Feuilles transparentes',
  'options.cutoutLeaves.tooltip' => 'Permet de voir à travers les espaces entre les feuilles. Désactiver cette option améliore les performances.',
  'options.damageTiltStrength' => 'Secousse de dégâts',
  'options.damageTiltStrength.tooltip' => 'Contrôle l\'intensité de la secousse de la vue causée par les dégâts reçus.',
  ...
  'options.debugGuiScale.tooltip' => 'Remplace la taille de l\'overlay de débogage par une valeur différente de celle utilisée pour le reste du jeu.',
  'options.debugGuiScale.unchanged' => 'Inchangée',
  ...
  'options.exclusiveFullscreen' => 'Plein écran exclusif',
  'options.exclusiveFullscreen.off.tooltip' => 'Toutes les méthodes de saisie sont censées fonctionner dans ce mode plein écran, mais la synchronisation adaptative (Nvidia G-Sync, AMD FreeSync) ne fonctionnera pas.',
  'options.exclusiveFullscreen.on.tooltip' => 'Ce mode plein écran pourrait empêcher certaines méthodes de saisie de fonctionner, mais la synchronisation adaptative (Nvidia G-Sync, AMD FreeSync) devrait fonctionner.',
  'options.exclusiveFullscreen.warningTooltip' => 'Cette option pourrait empêcher certaines méthodes de saisie de fonctionner.',
  ...
  'options.fovEffectScale' => 'Effets de champ de vision',
  ...
  'options.friendsList' => 'Liste d\'amis',
  'options.friendsList.confirm.message' => 'Utilisez votre liste d\'amis pour envoyer et recevoir des demandes d\'ami.

Gérez les paramètres de sécurité en ligne avec votre %s.',
  'options.friendsList.confirm.message.link' => 'compte Microsoft',
  'options.friendsList.confirm.title' => 'Liste d\'amis',
  'options.friendsList.confirm.turnOff' => 'Ne pas activer',
  'options.friendsList.confirm.turnOn' => 'Activer',
  'options.fullscreen' => 'Plein écran',
  'options.fullscreen.current' => 'Actuelle',
  'options.fullscreen.entry' => '%s × %s (%s Hz, %s bits)',
  'options.fullscreen.exclusive.mode' => 'Mode plein écran exclusif',
  'options.fullscreen.exclusive.mode.tooltip' => 'Ce paramètre ne prendra effet que si le mode plein écran exclusif est activé.',
  ...
  'options.graphics.custom' => 'Personnalisés',
...
Les effets de transparence sont désactivés pour certains blocs, tels que les feuilles d\'arbres.',
  'options.graphics.preset' => 'Préréglage',
  'options.graphics.preset.tooltip' => 'Définit les paramètres de "Qualité et performances" sur des valeurs par défaut adaptées à la qualité désirée.',
...
Vous pouvez ignorer cet avertissement et continuer, cependant aucune prise en charge ne sera fournie pour votre périphérique si vous choisissez d\'utiliser les graphismes "%s".',
  ...
  'options.graphicsApi' => 'API graphique',
  'options.graphicsApi.default' => 'Par défaut',
  'options.graphicsApi.opengl' => 'OpenGL',
  'options.graphicsApi.restart' => 'Vous devez redémarrer votre jeu pour changer l\'API graphique.',
  'options.graphicsApi.tooltip' => 'Définit l\'API graphique à privilégier pour le rendu. Laissez sur "Par défaut" à moins d\'avoir une raison spécifique de changer ce paramètre !',
  'options.graphicsApi.tooltip.vulkan' => 'Expérimental. Peut réduire les performances ou provoquer une instabilité sur certains systèmes.',
  'options.graphicsApi.vulkan' => 'Vulkan (expérimental)',
  'options.guiScale' => 'Taille de l\'interface',
  'options.guiScale.auto' => 'Auto',
  'options.hidden' => 'Masqué',
  'options.hideLightningFlashes' => 'Cacher les flashs',
  'options.hideLightningFlashes.tooltip' => 'Désactive les flashs lumineux produits par la foudre et les autres effets environnementaux dans le ciel. La source des flashs restera visible.',
...
Si cette option est activée, les joueurs masqués seront associés en fonction du nom des expéditeurs dans le tchat.',
  ...
  'options.improvedTransparency' => 'Transparence améliorée',
  'options.improvedTransparency.oit.tooltip' => 'Une approche expérimentale qui utilise un algorithme de transparence indépendant de l\'ordre pour éviter les problèmes graphiques généralement présents en observant à travers plusieurs couches d\'objets translucides.
Cela affectera les performances.',
  'options.improvedTransparency.tooltip' => 'Une approche expérimentale qui utilise un algorithme de transparence indépendant de l\'ordre pour éviter les problèmes graphiques généralement présents en observant à travers plusieurs couches d\'objets translucides.
Cela affectera les performances.',
  'options.inGameNotification' => 'Notification en jeu',
  'options.inGameNotification.tooltip' => 'Affiche les notifications d\'amis en jeu.',
  ...
  'options.invertMouseX' => 'Inverser l\'axe X',
  'options.invertMouseY' => 'Inverser l\'axe Y',
  ...
  'options.language.empty_or_missing_translation' => 'Le fichier de traduction de "%s" est vide ou manquant. Redémarrez le jeu et le Launcher puis réessayez.',
  'options.language.load_translations_failed' => 'Échec du chargement des traductions',
  'options.language.narration' => 'Changer la langue',
  'options.language.title' => 'Langue',
  'options.language.tooltip' => 'Changer la langue',
  ...
  'options.macFullscreenMenuVisibility' => 'Visibilité du menu/Dock',
  'options.macFullscreenMenuVisibility.tooltip' => 'Détermine si la barre des menus et le Dock de macOS peuvent être affichés en déplaçant la souris vers le bord de l\'écran en mode plein écran non exclusif.',
  'options.mainHand' => 'Main principale',
  'options.mainHand.left' => 'Gauche',
  'options.mainHand.right' => 'Droite',
  'options.maxAnisotropy' => 'Filtrage anisotrope',
  'options.maxAnisotropy.tooltip' => 'Chaque niveau améliore significativement l\'aspect lisse des textures, mais affecte les performances et augmente considérablement l\'utilisation de la mémoire vidéo. Nécessite que le filtrage des textures soit défini sur "Anisotrope".',
  ...
  'options.multiplayer.title' => 'Ouvrir au réseau local',
  'options.multiplier' => '%sx',
  'options.musicToast' => 'Notification musicale',
  'options.musicToast.never' => 'Non',
  'options.musicToast.never.tooltip' => 'Aucune notification musicale n\'est affichée.',
  'options.musicToast.pauseMenu' => 'Menu',
  'options.musicToast.pauseMenu.tooltip' => 'Une notification musicale est affichée en permanence dans le menu de pause pendant toute la durée de la musique.',
  'options.musicToast.pauseMenuAndToast' => 'Oui',
  'options.musicToast.pauseMenuAndToast.tooltip' => 'Affiche une notification lorsqu\'une musique commence à jouer. Cette même notification est affichée en permanence dans le menu de pause pendant toute la durée de la musique.',
  'options.music_frequency' => 'Fréquence musicale',
  'options.music_frequency.constant' => 'En continu',
  'options.music_frequency.default' => 'Par défaut',
  'options.music_frequency.frequent' => 'Fréquente',
  'options.music_frequency.tooltip' => 'Modifie la fréquence à laquelle la musique est jouée dans un monde.',
  ...
  'options.needsRestart' => 'Nécessite un redémarrage du jeu pour prendre effet.',
  ...
  'options.online.friends.header' => 'Liste d\'amis',
  'options.online.realms.header' => 'Realms',
  'options.online.servers.header' => 'Serveurs',
  'options.online.title' => 'Options en ligne',
  'options.online.xboxSettings' => 'Paramètres Xbox...',
  ...
  'options.quitShortcuts' => 'Raccourcis pour quitter',
  'options.quitShortcuts.tooltip' => 'Détermine si les raccourcis clavier peuvent fermer le jeu. Si l\'option est désactivée, appuyer sur Alt + F4 (sous Windows et Linux) et sur Cmd + Q (sur macOS) ne fermera plus le jeu.',
  'options.rawMouseInput' => 'Entrée brute',
  'options.realmsNotifications' => 'Notifications de Realms',
  'options.realmsNotifications.button' => 'Nouvelles et invitations',
  ...
  'options.renderCloudsDistance' => 'Distance des nuages',
  'options.renderDistance' => 'Distance d\'affichage',
  'options.resourcepack' => 'Packs de ressources...',
  'options.restartRequired' => 'Certaines modifications nécessitent un redémarrage du jeu.',
...
Si la valeur est faible, l\'effet de nausée est remplacé par un contour vert.',
  ...
  'options.sharePresence' => 'Visibilité',
  'options.sharePresence.all' => 'Totale',
  'options.sharePresence.all.tooltip' => 'Vos amis peuvent voir votre activité de jeu.',
  'options.sharePresence.limited' => 'Limitée',
  'options.sharePresence.limited.tooltip' => 'Vos amis peuvent voir quand vous êtes en ligne, mais pas votre activité de jeu.',
  'options.sharePresence.none' => 'Aucune',
  'options.sharePresence.none.tooltip' => 'Vos amis vous verront toujours hors ligne.',
  'options.showNowPlayingToast' => 'Notification musicale',
  'options.showNowPlayingToast.tooltip' => 'Affiche une notification lorsqu\'une musique commence à jouer. Cette même notification reste affichée en permanence dans le menu de pause du jeu pendant toute la durée de la musique.',
  'options.showSubtitles' => 'Sous-titres',
  'options.showSubtitles.tooltip' => 'Active les sous-titres des sons joués en jeu.',
  ...
  'options.sprintWindow' => 'Intervalle pour courir',
  'options.sprintWindow.tooltip' => 'Intervalle de temps en ticks pendant lequel appuyer deux fois sur la touche "Avancer" permet de courir.',
...
"%s" inclut les données facultatives et requises.',
  ...
  'options.textureFiltering' => 'Filtrage des textures',
  'options.textureFiltering.anisotropic' => 'Anisotrope',
  'options.textureFiltering.anisotropic.tooltip' => 'Une méthode de filtrage matérielle qui affecte les performances et augmente considérablement l\'utilisation de la mémoire vidéo. Peut ne pas être prise en charge sur tous les appareils.',
  'options.textureFiltering.none' => 'Non',
  'options.textureFiltering.none.tooltip' => 'Les textures sont affichées sans aucun filtrage. Les blocs peuvent paraître flous lorsqu\'ils sont vus sous certains angles.',
  'options.textureFiltering.rgss' => 'SEGR',
  'options.textureFiltering.rgss.tooltip' => 'Le super-échantillonnage à grille rotative (SEGR) est une méthode de filtrage basée sur les shaders qui améliore la qualité des textures avec un impact modéré sur les performances.',
  'options.title' => 'Options',
  'options.touchscreen' => 'Mode écran tactile',
  'options.value' => '%s',
  'options.video' => 'Graphismes...',
  'options.video.display.header' => 'Affichage',
  'options.video.interface.header' => 'Interface',
  'options.video.preferences.header' => 'Préférences',
  'options.video.quality.header' => 'Qualité et performances',
  'options.videoTitle' => 'Options graphiques',
  'options.viewBobbing' => 'Mouvement de tête',
  'options.vignette' => 'Vignettage',
  'options.vignette.tooltip' => 'Une texture subtile appliquée à l\'écran de jeu pour réduire la luminosité vers les bords de la vision et indiquer au joueur qu\'il approche de la bordure du monde.',
  'options.visible' => 'Visible',
  'options.vsync' => 'Synchro verticale',
  'options.weatherRadius' => 'Rayon des effets météo',
  'options.weatherRadius.tooltip' => 'Rayon de la zone où les effets de pluie et de neige sont visibles. Impact très faible sur les performances.',
  'options.worldOptions.allow_commands.disabled.demo.tooltip' => 'Impossible d\'autoriser les commandes dans un monde de démo.',
  'options.worldOptions.allow_commands.disabled.tooltip' => 'Impossible d\'autoriser les commandes dans un monde Hardcore.',
  'options.worldOptions.allow_commands.tooltip' => 'Permet l\'utilisation des commandes dans ce monde.',
  'options.worldOptions.button' => 'Options du monde...',
  'options.worldOptions.difficulty.disabled.hardcore.tooltip' => 'Impossible de changer la difficulté dans un monde Hardcore.',
  'options.worldOptions.difficulty.disabled.locked.tooltip' => 'La difficulté est verrouillée.',
  'options.worldOptions.difficulty.disabled.operator.tooltip' => 'Le changement de la difficulté nécessite des permissions d\'opérateur.',
  'options.worldOptions.game_mode' => 'Mode de jeu par défaut',
  'options.worldOptions.game_mode.disabled.operator.tooltip' => 'Le changement du mode de jeu nécessite des permissions d\'opérateur.',
  'options.worldOptions.game_mode.disabled.tooltip' => 'Impossible de changer le mode de jeu dans un monde Hardcore.',
  'options.worldOptions.game_mode.tooltip' => 'Change le mode de jeu par défaut du monde.',
  'options.worldOptions.general.title' => 'Général',
  'options.worldOptions.guest.command_access' => 'Accès aux commandes',
  'options.worldOptions.guest.command_access.disabled.commands.tooltip' => 'Impossible de modifier le niveau d\'accès aux commandes des joueurs qui rejoignent votre monde lorsque les commandes ne sont pas autorisées.',
  'options.worldOptions.guest.command_access.disabled.scope.tooltip' => 'Impossible de modifier l\'accès aux commandes des joueurs qui rejoignent votre monde lorsque le mode multijoueur du monde est désactivé.',
  'options.worldOptions.guest.command_access.tooltip' => 'Détermine si les joueurs qui rejoignent votre monde peuvent utiliser des commandes ou non.',
  'options.worldOptions.guest.force_game_mode' => 'Forcer le mode de jeu',
  'options.worldOptions.guest.force_game_mode.off.commands.tooltip' => 'Les autres joueurs peuvent définir leur propre mode de jeu à l\'aide de commandes.',
  'options.worldOptions.guest.force_game_mode.off.hardcore.tooltip' => 'Impossible de modifier ce paramètre dans un monde Hardcore.',
  'options.worldOptions.guest.force_game_mode.off.scope.tooltip' => 'Impossible de modifier ce paramètre lorsque le mode multijoueur du monde est désactivé.',
  'options.worldOptions.guest.force_game_mode.off.tooltip' => 'Les autres joueurs conserveront leur mode de jeu actuel, quel que soit le mode de jeu par défaut du monde.',
  'options.worldOptions.guest.force_game_mode.on.tooltip' => 'Les autres joueurs seront forcés de jouer dans le mode de jeu par défaut du monde.',
  'options.worldOptions.multiplayer.title' => 'Multijoueur',
  'options.worldOptions.personal_game_mode' => 'Mode de jeu personnel',
  'options.worldOptions.personal_game_mode.tooltip' => 'Change votre mode de jeu dans ce monde.',
  'options.worldOptions.title' => 'Options du monde',
...
%s',
  ...
  'pack.incompatible.confirm.unknown' => 'Ce pack est endommagé ou a été conçu pour une version inconnue de Minecraft et peut ne pas fonctionner correctement.',
  ...
  'pack.incompatible.unknown' => '(Endommagé ou incompatible)',
  ...
  'painting.minecraft.kebab.title' => 'Le Kebab aux trois piments',
  ...
  'parsing.bool.invalid' => 'Booléen non valide : %s ("true" ou "false" attendu)',
  ...
  'quickplay.error.realm_connect' => 'Impossible de se connecter à ce Realm',
  ...
  'realms.configuration.region.australia_east' => 'Australie (Nouvelle-Galles du Sud)',
  'realms.configuration.region.australia_southeast' => 'Australie (Victoria)',
  'realms.configuration.region.brazil_south' => 'Brésil',
  'realms.configuration.region.canada_central' => 'Canada',
  'realms.configuration.region.central_india' => 'Inde',
  'realms.configuration.region.central_us' => 'États-Unis (Iowa)',
  'realms.configuration.region.east_asia' => 'Hong Kong',
  'realms.configuration.region.east_us' => 'États-Unis (Virginie)',
  'realms.configuration.region.east_us_2' => 'États-Unis (Caroline du Nord)',
  'realms.configuration.region.france_central' => 'France',
  'realms.configuration.region.japan_east' => 'Japon oriental',
  'realms.configuration.region.japan_west' => 'Japon occidental',
  'realms.configuration.region.korea_central' => 'Corée du Sud',
  'realms.configuration.region.mexico_central' => 'Mexique',
  'realms.configuration.region.north_central_us' => 'États-Unis (Illinois)',
  'realms.configuration.region.north_europe' => 'Irlande',
  'realms.configuration.region.south_africa_north' => 'Afrique du Sud',
  'realms.configuration.region.south_central_us' => 'États-Unis (Texas)',
  'realms.configuration.region.southeast_asia' => 'Singapour',
  'realms.configuration.region.sweden_central' => 'Suède',
  'realms.configuration.region.uae_north' => 'Émirats arabes unis',
  'realms.configuration.region.uk_south' => 'Angleterre méridionale',
  'realms.configuration.region.west_central_us' => 'États-Unis (Utah)',
  'realms.configuration.region.west_europe' => 'Pays-Bas',
  'realms.configuration.region.west_us' => 'États-Unis (Californie)',
  'realms.configuration.region.west_us_2' => 'États-Unis (Washington)',
  'realms.configuration.region.west_us_3' => 'États-Unis (Arizona)',
  'realms.configuration.region_preference.automatic_owner' => 'Automatique (région du propriétaire)',
  'realms.configuration.region_preference.automatic_player' => 'Automatique (premier à rejoindre)',
...
Essayez de restaurer le monde à partir d\'un état antérieur ou signalez le bug sur le site dédié.',
  ...
  'restrictions_screen.permission.receive_player_messages.allowed' => 'Vous pouvez recevoir des messages des joueurs',
  'restrictions_screen.permission.receive_player_messages.denied' => 'Vous ne pouvez pas recevoir de messages des joueurs',
  'restrictions_screen.permission.receive_system_messages.allowed' => 'Vous pouvez recevoir des messages système du serveur',
  'restrictions_screen.permission.receive_system_messages.denied' => 'Vous ne pouvez pas recevoir de messages système du serveur',
  'restrictions_screen.permission.send_commands.allowed' => 'Vous pouvez envoyer des commandes',
  'restrictions_screen.permission.send_commands.denied' => 'Vous ne pouvez pas envoyer de commandes',
  'restrictions_screen.permission.send_messages.allowed' => 'Vous pouvez envoyer des messages dans le tchat',
  'restrictions_screen.permission.send_messages.denied' => 'Vous ne pouvez pas envoyer de messages dans le tchat',
  ...
  'selectWorld.backupQuestion.file_fixing_required' => 'Créer une sauvegarde avant de mettre à niveau ce monde ?',
  ...
  'selectWorld.backupWarning.file_fixing_required' => 'Ce monde doit être mis à niveau avant de pouvoir y jouer. Nous vous recommandons fortement de créer une sauvegarde avant de continuer, au cas où vous rencontreriez une corruption de votre monde.',
...
Cette configuration requiert des fonctionnalités qui sont toujours en développement. Votre monde pourrait planter, se corrompre ou ne plus fonctionner avec les futures mises à jour.',
  ...
  'selectWorld.gameMode.hardcore.info' => 'Identique au mode Survie, mais verrouillé sur la difficulté "Difficile". Vous ne pouvez pas réapparaître si vous mourez.',
...
Il a été ouvert pour la dernière fois en version %s.',
  ...
  'selectWorld.locked' => 'Déjà ouvert dans une autre instance de Minecraft.',
  ...
  'selectWorld.requiresFileFixingTooltip.edit' => 'Ce monde doit être mis à niveau vers la dernière version avant de pouvoir être modifié, en raison de changements structurels apportés au format du monde.',
  'selectWorld.requiresFileFixingTooltip.play' => 'Ce monde doit être mis à niveau vers la dernière version avant de pouvoir y jouer, en raison de changements structurels apportés au format du monde.',
  'selectWorld.requiresFileFixingTooltip.recreate' => 'Ce monde doit être mis à niveau vers la dernière version avant de pouvoir être recréé, en raison de changements structurels apportés au format du monde.',
  ...
  'selectWorld.tooltip.fromNewerVersion2' => 'récente et le charger pourrait causer des problèmes !',
  ...
  'selectWorld.upgrade_and_play' => 'Mettre à niveau et jouer',
  ...
  'selectWorld.waitingForBackup.message' => 'Selon la taille de votre monde, cela peut prendre un certain temps. Veuillez ne pas fermer le jeu ni éteindre votre appareil.',
  'selectWorld.waitingForBackup.title' => 'Création de la sauvegarde',
...
Manquer d\'espace disque durant la partie pourrait endommager votre monde.',
  ...
  'selectWorld.world_gen_settings_access' => 'Impossible de lire ou d\'accéder au fichier des paramètres de génération du monde ! %s',
  'selecteWorld.backupRequiredTooltip' => 'Charger ce monde nécessite de faire une sauvegarde au préalable',
  'sign.back_text' => 'Texte au verso :',
  'sign.click_actions_disabled' => 'Les actions de clic sont désactivées sur cette pancarte',
  'sign.edit' => 'Texte de la pancarte :',
  'sign.front_text' => 'Texte au recto :',
  ...
  'slot.only_single_allowed' => 'Seuls les emplacements uniques sont autorisés (valeur reçue : %s)',
  ...
  'soundCategory.ui' => 'Interface',
  'soundCategory.voice' => 'Narrateur',
  'soundCategory.weather' => 'Météo',
  'spectator.cannot_teleport' => 'Impossible de se téléporter. La destination n\'a pas encore été générée.',
  ...
  'stat.minecraft.happy_ghast_one_cm' => 'Distance sur un Ghast joyeux',
  ...
  'stat.minecraft.interact_with_cartography_table' => 'Interactions avec une table de cartographie',
  ...
  'stat.minecraft.interact_with_stonecutter' => 'Interactions avec un tailleur de pierre',
  ...
  'stat.minecraft.nautilus_one_cm' => 'Distance sur un nautile',
  ...
  'stat.minecraft.sleep_in_straw_bed' => 'Nuits passées dans un lit de paille',
  ...
  'structure_block.invalid_structure_name' => '"%s" n\'est pas un nom de structure valide',
  ...
  'structure_block.size_success' => 'La taille de la structure "%s" a été détectée',
  ...
  'subtitles.block.copper_chest.close' => 'Coffre qui se ferme',
  'subtitles.block.copper_chest.open' => 'Coffre qui s\'ouvre',
  ...
  'subtitles.block.creaking_heart.hurt' => 'Cœur de grinceur qui gronde',
  ...
  'subtitles.block.dried_ghast.ambient' => 'Bruits de dessèchement',
  'subtitles.block.dried_ghast.ambient_water' => 'Ghast desséché qui se réhydrate',
  'subtitles.block.dried_ghast.place_in_water' => 'Ghast desséché qui s\'imbibe',
  'subtitles.block.dried_ghast.transition' => 'Ghast desséché qui se vivifie',
  'subtitles.block.dry_grass.ambient' => 'Bruits de vent',
  ...
  'subtitles.block.poplar_leaves.ambient' => 'Bruissement de feuilles',
  ...
  'subtitles.block.potent_sulfur.geyser_eruption' => 'Éruption de source sulfureuse',
  'subtitles.block.potent_sulfur.noxious_gas' => 'Gaz nocif qui apparaît',
  ...
  'subtitles.block.shelf.activate' => 'Étagère activée',
  'subtitles.block.shelf.deactivate' => 'Étagère désactivée',
  'subtitles.block.shelf.multi_swap' => 'Objets échangés',
  'subtitles.block.shelf.place_item' => 'Objet placé',
  'subtitles.block.shelf.single_swap' => 'Objet échangé',
  'subtitles.block.shelf.take_item' => 'Objet retiré',
  'subtitles.block.shelf_mushroom.bounce' => 'Rebond sur un polypore',
  ...
  'subtitles.block.straw_bed.break_leave' => 'Lit de paille détruit',
  'subtitles.block.sweet_berry_bush.pick_berries' => 'Baies cueillies',
  'subtitles.block.trapdoor.close' => 'Trappe qui se ferme',
  'subtitles.block.trapdoor.open' => 'Trappe qui s\'ouvre',
  ...
  'subtitles.entity.baby_cat.ambient' => 'Miaulement de chaton',
  'subtitles.entity.baby_cat.beg_for_food' => 'Chaton qui quémande',
  'subtitles.entity.baby_cat.death' => 'Chaton qui meurt',
  'subtitles.entity.baby_cat.eat' => 'Chaton qui mange',
  'subtitles.entity.baby_cat.hiss' => 'Sifflement de chaton',
  'subtitles.entity.baby_cat.hurt' => 'Chaton blessé',
  'subtitles.entity.baby_cat.purr' => 'Ronronnement de chaton',
  'subtitles.entity.baby_chicken.ambient' => 'Pépiement de poussin',
  'subtitles.entity.baby_chicken.death' => 'Poussin qui meurt',
  'subtitles.entity.baby_chicken.hurts' => 'Poussin blessé',
  'subtitles.entity.baby_horse.ambient' => 'Hennissement de poulain',
  'subtitles.entity.baby_horse.angry' => 'Hennissement de poulain',
  'subtitles.entity.baby_horse.breathe' => 'Souffle de poulain',
  'subtitles.entity.baby_horse.death' => 'Poulain qui meurt',
  'subtitles.entity.baby_horse.eat' => 'Poulain qui mange',
  'subtitles.entity.baby_horse.hurt' => 'Poulain blessé',
  'subtitles.entity.baby_horse.land' => 'Poulain qui atterrit',
  'subtitles.entity.baby_nautilus.ambient' => 'Gazouillis de bébé nautile',
  'subtitles.entity.baby_nautilus.ambient_land' => 'Gazouillis de bébé nautile',
  'subtitles.entity.baby_nautilus.death' => 'Bébé nautile qui meurt',
  'subtitles.entity.baby_nautilus.death_land' => 'Bébé nautile qui meurt',
  'subtitles.entity.baby_nautilus.eat' => 'Bébé nautile qui mange',
  'subtitles.entity.baby_nautilus.hurt' => 'Bébé nautile blessé',
  'subtitles.entity.baby_nautilus.hurt_land' => 'Bébé nautile blessé',
  'subtitles.entity.baby_nautilus.swim' => 'Bébé nautile qui nage',
  'subtitles.entity.baby_pig.ambient' => 'Grouinement de porcelet',
  'subtitles.entity.baby_pig.death' => 'Porcelet qui meurt',
  'subtitles.entity.baby_pig.eat' => 'Porcelet qui mange',
  'subtitles.entity.baby_pig.hurt' => 'Porcelet blessé',
  'subtitles.entity.baby_wolf.ambient' => 'Jappement de louveteau',
  'subtitles.entity.baby_wolf.death' => 'Louveteau qui meurt',
  'subtitles.entity.baby_wolf.growl' => 'Grognement de louveteau',
  'subtitles.entity.baby_wolf.hurt' => 'Louveteau blessé',
  'subtitles.entity.baby_wolf.pant' => 'Halètement de louveteau',
  'subtitles.entity.baby_wolf.whine' => 'Gémissement de louveteau',
  ...
  'subtitles.entity.camel_husk.ambient' => 'Grognement de dromadaire momifié',
  'subtitles.entity.camel_husk.dash' => 'Dromadaire momifié qui fonce',
  'subtitles.entity.camel_husk.dash_ready' => 'Dromadaire momifié qui récupère',
  'subtitles.entity.camel_husk.death' => 'Dromadaire momifié qui meurt',
  'subtitles.entity.camel_husk.eat' => 'Dromadaire momifié qui mange',
  'subtitles.entity.camel_husk.hurt' => 'Dromadaire momifié blessé',
  'subtitles.entity.camel_husk.saddle' => 'Selle équipée',
  'subtitles.entity.camel_husk.sit' => 'Dromadaire momifié qui s\'assoit',
  'subtitles.entity.camel_husk.stand' => 'Dromadaire momifié qui se lève',
  ...
  'subtitles.entity.copper_golem.death' => 'Golem de cuivre qui meurt',
  'subtitles.entity.copper_golem.hurt' => 'Golem de cuivre blessé',
  'subtitles.entity.copper_golem.item_drop' => 'Golem de cuivre qui place un objet',
  'subtitles.entity.copper_golem.item_no_drop' => 'Golem de cuivre qui échoue',
  'subtitles.entity.copper_golem.no_item_get' => 'Golem de cuivre qui prend un objet',
  'subtitles.entity.copper_golem.no_item_no_get' => 'Golem de cuivre qui ne trouve pas d\'objet',
  'subtitles.entity.copper_golem.spawn' => 'Golem de cuivre qui apparaît',
  'subtitles.entity.copper_golem.spin' => 'Golem de cuivre qui tournoie de la tête',
  'subtitles.entity.copper_golem_become_statue' => 'Golem de cuivre qui se pétrifie',
  'subtitles.entity.copper_golem_oxidized.death' => 'Golem de cuivre qui meurt',
  'subtitles.entity.copper_golem_oxidized.hurt' => 'Golem de cuivre blessé',
  'subtitles.entity.copper_golem_oxidized.spin' => 'Golem de cuivre qui tournoie de la tête',
  'subtitles.entity.copper_golem_weathered.death' => 'Golem de cuivre qui meurt',
  'subtitles.entity.copper_golem_weathered.hurt' => 'Golem de cuivre blessé',
  'subtitles.entity.copper_golem_weathered.spin' => 'Golem de cuivre qui tournoie de la tête',
  ...
  'subtitles.entity.creaking.ambient' => 'Grincement de grinceur',
  ...
  'subtitles.entity.cushion.break' => 'Coussin retiré',
  'subtitles.entity.cushion.get_up' => 'Coussin libéré',
  'subtitles.entity.cushion.place' => 'Coussin placé',
  'subtitles.entity.cushion.sit' => 'Coussin occupé',
  ...
  'subtitles.entity.ghastling.ambient' => 'Gazouillis de Ghastelin',
  'subtitles.entity.ghastling.death' => 'Ghastelin qui meurt',
  'subtitles.entity.ghastling.hurt' => 'Ghastelin blessé',
  'subtitles.entity.ghastling.spawn' => 'Ghastelin qui apparaît',
  ...
  'subtitles.entity.happy_ghast.ambient' => 'Fredonnement de Ghast joyeux',
  'subtitles.entity.happy_ghast.death' => 'Ghast joyeux qui meurt',
  'subtitles.entity.happy_ghast.equip' => 'Harnais équipé',
  'subtitles.entity.happy_ghast.harness_goggles_down' => 'Ghast joyeux qui est prêt',
  'subtitles.entity.happy_ghast.harness_goggles_up' => 'Ghast joyeux qui s\'arrête',
  'subtitles.entity.happy_ghast.hurt' => 'Ghast joyeux blessé',
  'subtitles.entity.happy_ghast.riding' => 'Vent qui souffle',
  'subtitles.entity.happy_ghast.unequip' => 'Harnais retiré',
  ...
  'subtitles.entity.horse.armor' => 'Armure pour cheval équipée',
  ...
  'subtitles.entity.husk.ambient' => 'Grognement de momifié',
  'subtitles.entity.husk.converted_to_zombie' => 'Momifié converti en zombie',
  'subtitles.entity.husk.death' => 'Momifié qui meurt',
  'subtitles.entity.husk.hurt' => 'Momifié blessé',
  ...
  'subtitles.entity.item.break' => 'Objet qui se casse',
  ...
  'subtitles.entity.nautilus.ambient' => 'Claquement de nautile',
  'subtitles.entity.nautilus.ambient_land' => 'Claquement de nautile',
  'subtitles.entity.nautilus.dash' => 'Nautile qui se propulse',
  'subtitles.entity.nautilus.dash_land' => 'Nautile qui se propulse',
  'subtitles.entity.nautilus.dash_ready' => 'Nautile qui récupère',
  'subtitles.entity.nautilus.dash_ready_land' => 'Nautile qui récupère',
  'subtitles.entity.nautilus.death' => 'Nautile qui meurt',
  'subtitles.entity.nautilus.death_land' => 'Nautile qui meurt',
  'subtitles.entity.nautilus.eat' => 'Nautile qui mange',
  'subtitles.entity.nautilus.hurt' => 'Nautile blessé',
  'subtitles.entity.nautilus.hurt_land' => 'Nautile blessé',
  'subtitles.entity.nautilus.riding' => 'Nautile qui fait des bulles',
  'subtitles.entity.nautilus.swim' => 'Nautile qui nage',
  ...
  'subtitles.entity.parched.ambient' => 'Craquement de desséché',
  'subtitles.entity.parched.death' => 'Desséché qui meurt',
  'subtitles.entity.parched.hurt' => 'Desséché blessé',
  ...
  'subtitles.entity.parrot.imitate.camel_husk' => 'Perroquet qui imite le dromadaire momifié',
  ...
  'subtitles.entity.parrot.imitate.husk' => 'Perroquet qui imite le momifié',
  ...
  'subtitles.entity.parrot.imitate.parched' => 'Perroquet qui imite le desséché',
  ...
  'subtitles.entity.parrot.imitate.zombie_horse' => 'Perroquet qui imite le cheval-zombie',
  'subtitles.entity.parrot.imitate.zombie_nautilus' => 'Perroquet qui imite le nautile-zombie',
  ...
  'subtitles.entity.pig.eat' => 'Cochon qui mange',
  ...
  'subtitles.entity.small_sulfur_cube.death' => 'Petit cube de soufre qui meurt',
  'subtitles.entity.small_sulfur_cube.eat' => 'Petit cube de soufre qui absorbe',
  'subtitles.entity.small_sulfur_cube.hurt' => 'Petit cube de soufre blessé',
  'subtitles.entity.small_sulfur_cube.jump' => 'Petit cube de soufre qui saute',
  ...
  'subtitles.entity.sulfur_cube.absorb' => 'Cube de soufre plein',
  'subtitles.entity.sulfur_cube.bounce' => 'Cube de soufre qui rebondit',
  'subtitles.entity.sulfur_cube.death' => 'Cube de soufre qui meurt',
  'subtitles.entity.sulfur_cube.eject' => 'Bloc retiré',
  'subtitles.entity.sulfur_cube.hit' => 'Cube de soufre touché',
  'subtitles.entity.sulfur_cube.hurt' => 'Cube de soufre blessé',
  'subtitles.entity.sulfur_cube.jump' => 'Cube de soufre qui saute',
  'subtitles.entity.sulfur_cube.push' => 'Cube de soufre poussé',
  'subtitles.entity.sulfur_cube.squish' => 'Cube de soufre qui saute',
  ...
  'subtitles.entity.zombie_horse.angry' => 'Hennissement de cheval-zombie',
  'subtitles.entity.zombie_horse.death' => 'Cheval-zombie qui meurt',
  'subtitles.entity.zombie_horse.eat' => 'Cheval-zombie qui mange',
  'subtitles.entity.zombie_horse.hurt' => 'Cheval-zombie blessé',
  'subtitles.entity.zombie_nautilus.ambient' => 'Gargouillis de nautile-zombie',
  'subtitles.entity.zombie_nautilus.ambient_land' => 'Gargouillis de nautile-zombie',
  'subtitles.entity.zombie_nautilus.dash' => 'Nautile-zombie qui se propulse',
  'subtitles.entity.zombie_nautilus.dash_land' => 'Nautile-zombie qui se propulse',
  'subtitles.entity.zombie_nautilus.dash_ready' => 'Nautile-zombie qui récupère',
  'subtitles.entity.zombie_nautilus.dash_ready_land' => 'Nautile-zombie qui récupère',
  'subtitles.entity.zombie_nautilus.death' => 'Nautile-zombie qui meurt',
  'subtitles.entity.zombie_nautilus.death_land' => 'Nautile-zombie qui meurt',
  'subtitles.entity.zombie_nautilus.eat' => 'Nautile-zombie qui mange',
  'subtitles.entity.zombie_nautilus.hurt' => 'Nautile-zombie blessé',
  'subtitles.entity.zombie_nautilus.hurt_land' => 'Nautile-zombie blessé',
  'subtitles.entity.zombie_nautilus.swim' => 'Nautile-zombie qui nage',
  ...
  'subtitles.item.armor.equip_copper' => 'Tintement d\'armure en cuivre',
  ...
  'subtitles.item.armor.equip_nautilus' => 'Armure pour nautile équipée',
  ...
  'subtitles.item.armor.unequip_nautilus' => 'Armure pour nautile retirée',
  ...
  'subtitles.item.bucket.fill_sulfur_cube' => 'Cube de soufre récupéré',
  ...
  'subtitles.item.golden_dandelion.unuse' => 'Croissance relancée',
  'subtitles.item.golden_dandelion.use' => 'Croissance interrompue',
  ...
  'subtitles.item.horse_armor.unequip' => 'Armure pour cheval retirée',
  'subtitles.item.ink_sac.use' => 'Poche d\'encre qui tache',
  'subtitles.item.lead.break' => 'Laisse rompue',
  'subtitles.item.lead.tied' => 'Laisse attachée',
  'subtitles.item.lead.untied' => 'Laisse détachée',
  'subtitles.item.llama_carpet.unequip' => 'Tapis retiré',
  ...
  'subtitles.item.nautilus_saddle_equip' => 'Selle équipée',
  'subtitles.item.nautilus_saddle_underwater_equip' => 'Selle équipée',
  'subtitles.item.nether_wart.plant' => 'Culture plantée',
  'subtitles.item.ominous_bottle.dispose' => 'Fiole brisée',
  'subtitles.item.saddle.unequip' => 'Selle retirée',
  'subtitles.item.shears.shear' => 'Pincement de cisailles',
  'subtitles.item.shears.snip' => 'Coup de cisailles',
  'subtitles.item.shield.block' => 'Parade de bouclier',
  'subtitles.item.shovel.flatten' => 'Aplatissement à la pelle',
  'subtitles.item.spear.attack' => 'Coup de lance',
  'subtitles.item.spear.hit' => 'Impact de lance',
  'subtitles.item.spear.lunge' => 'Lance qui élance',
  'subtitles.item.spear.use' => 'Charge avec une lance',
  'subtitles.item.spear_wood.attack' => 'Coup de lance',
  'subtitles.item.spear_wood.hit' => 'Impact de lance',
  'subtitles.item.spear_wood.use' => 'Charge avec une lance',
  ...
  'subtitles.item.underwater_saddle.equip' => 'Selle équipée',
  ...
  'subtitles.weather.end_flash' => 'Tonnerre de l\'End',
  ...
  'telemetry.event.graphics_capabilities.description' => 'Cet événement nous informe des capacités du périphérique graphique utilisé pour jouer au jeu.',
  'telemetry.event.graphics_capabilities.title' => 'Capacités graphiques',
  'telemetry.event.optional' => '%s (facultatif)',
  'telemetry.event.optional.disabled' => '%s (facultatif) - désactivé',
  'telemetry.event.p2p_connection.description' => 'Cet événement nous aide à évaluer la fiabilité et les performances des connexions pair à pair entre les joueurs. Il enregistre la réussite ou l\'échec de la connexion, le type de candidat utilisé pour l\'établissement de connectivité interactive (ICE, le protocole que nous utilisons pour établir les connexions pair à pair) ainsi que le temps nécessaire pour établir la connexion.',
  'telemetry.event.p2p_connection.title' => 'Connexion pair à pair',
  'telemetry.event.performance_metrics.description' => 'En apprendre davantage sur le profil global des performances de Minecraft nous aide à ajuster et optimiser le jeu pour un large éventail d\'appareils et de systèmes d\'exploitation. 
La version du jeu est incluse pour nous aider à comparer le profil des performances des nouvelles versions de Minecraft.',
...
La durée (en secondes et en ticks) est mesurée lorsqu\'une session de jeu est terminée (en retournant au menu principal ou en se déconnectant d\'un serveur).',
  ...
  'telemetry.property.backend_failure_message.title' => 'Message d\'échec de la création du backend',
  'telemetry.property.backend_failure_missing_capabilities.title' => 'Capacités manquantes lors de l\'échec de la création du backend',
  'telemetry.property.backend_failure_reason.title' => 'Raison de l\'échec de la création du backend',
  'telemetry.property.backend_name.title' => 'Nom du backend',
  ...
  'telemetry.property.load_time_total_time_ms.title' => 'Temps total de chargement (en millisecondes)',
  ...
  'telemetry.property.p2p_connection_failure_stage.title' => 'Phase de l\'échec',
  'telemetry.property.p2p_connection_ice_connect_time_ms.title' => 'Temps de connexion de l\'établissement de connectivité interactive (ICE) (en millisecondes)',
  'telemetry.property.p2p_connection_ice_path.title' => 'Chemin de l\'établissement de connectivité interactive (ICE)',
  'telemetry.property.p2p_connection_local_candidate_type.title' => 'Type de candidat local',
  'telemetry.property.p2p_connection_remote_candidate_type.title' => 'Type de candidat distant',
  'telemetry.property.p2p_connection_signaling_time_ms.title' => 'Temps de connexion de la signalisation (en millisecondes)',
  'telemetry.property.p2p_connection_successful.title' => 'Connexion réussie',
  'telemetry.property.p2p_connection_total_time_ms.title' => 'Temps total de connexion (en millisecondes)',
  ...
  'telemetry.property.server_session_id.title' => 'ID de la session du serveur',
...
Vous pouvez aussi donner votre avis pour nous aider à améliorer le jeu.',
  ...
  'test.error.block_property_mismatch' => 'Valeur de la propriété "%s" attendue : %s (valeur reçue : %s)',
  'test.error.block_property_missing' => 'Propriété de bloc manquante. Valeur de la propriété "%s" attendue : %s',
  'test.error.entity_property' => 'Échec du test de l\'entité "%s" : %s',
  'test.error.entity_property_details' => 'L\'entité "%s" a échoué le test : %s (valeur attendue : %s, valeur reçue : %s)',
  'test.error.expected_block' => 'Bloc "%s" attendu (bloc reçu : "%s")',
  'test.error.expected_block_present' => 'Présence du bloc "%s" attendue',
  'test.error.expected_block_tag' => 'Bloc attendu dans le tag #%s (valeur reçue : "%s")',
  ...
  'test.error.expected_entity_data' => 'Données d\'entité attendues : %s (valeur reçue : %s)',
  ...
  'test.error.not_a_block_item' => 'Le bloc spécifié n\'est pas un bloc sous forme d\'objet',
  ...
  'test.error.sequence.minimum_tick' => 'Réussite avant le tick attendu : le tick minimum attendu était de %s',
  ...
  'test.error.state_not_equal' => 'État incorrect (état attendu : %s, état reçu : %s)',
  ...
  'test.error.value_not_equal' => 'Valeur %s attendue : %s (valeur reçue : %s)',
  'test.error.value_not_in_between' => 'Valeur %s attendue entre %s et %s (valeur reçue : %s)',
  'test.error.wrong_block_entity' => 'Type d\'entité de bloc incorrect : %s',
  'test.player.coordinates' => 'Coordonnées du joueur : [%s, %s, %s] dans la dimension %s',
  'test.run.coordinates' => 'Coordonnées de test : [%s, %s, %s] dans la dimension %s',
  ...
  'test_instance.description.batch' => 'Environnement : %s',
  'test_instance.description.dimension' => 'Dimension : %s',
  ...
  'title.multiplayer.online' => 'Multijoueur (en ligne)',
  ...
  'trim_pattern.minecraft.eye' => 'Ornement de l\'oeil',
  ...
  'upgradeWorld.aborted.file_already_exists' => 'Le dossier du monde semble déjà contenir des fichiers mis à niveau. Le jeu ne peut pas mettre votre monde à niveau correctement.',
  'upgradeWorld.aborted.message' => 'Cela peut se produire si un autre programme a accédé au monde pendant la mise à niveau.
Redémarrer votre ordinateur et réessayer pourrait aider. Si le problème persiste, pensez à signaler le bug.',
  'upgradeWorld.aborted.reportBug' => 'Signaler un bug',
  'upgradeWorld.aborted.title' => 'Échec de la mise à niveau du monde',
  'upgradeWorld.canceled.message' => 'Votre monde reste inchangé.',
  'upgradeWorld.canceled.title' => 'Mise à niveau du monde annulée',
  'upgradeWorld.done' => 'Mise à niveau du monde terminée',
  'upgradeWorld.failed_cleanup.message' => 'Le monde a été mis à niveau vers la version actuelle et est désormais disponible dans la liste des mondes.
Nous avons rencontré des problèmes lors du nettoyage des données obsolètes, le nom du dossier du monde a donc été modifié en %s.',
  'upgradeWorld.failed_cleanup.title' => 'Mise à niveau du monde réussie',
  'upgradeWorld.info.converted' => 'Mis à niveau : %s',
  'upgradeWorld.info.file_fix_stage' => 'Étape : %s/%s',
  'upgradeWorld.info.scanning' => 'Analyse des fichiers...',
  'upgradeWorld.info.total' => 'Total : %s',
  'upgradeWorld.joinNow' => 'Voulez-vous rejoindre le monde maintenant ?',
  'upgradeWorld.progress.percentage' => '%s %%',
  'upgradeWorld.progress.type.files' => 'Déplacement des fichiers',
  'upgradeWorld.progress.type.legacy_structures' => 'Mise à niveau des anciennes structures',
  'upgradeWorld.progress.type.region' => 'Mise à niveau des régions',
  'upgradeWorld.symlink.message' => 'Le monde sélectionné contient des liens symboliques.
Les étapes nécessaires pour mettre à niveau le monde vers la version actuelle ne prennent pas en charge l\'utilisation de liens symboliques. Pour mettre à niveau le monde, les liens doivent d\'abord être résolus.',
  'upgradeWorld.symlink.title' => 'Impossible de mettre à niveau le monde',
  'upgradeWorld.title' => 'Mise à niveau des fichiers du monde',
);
